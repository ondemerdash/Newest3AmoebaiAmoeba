      ...
      subroutine empole1d_3b_PolarPerm1btest(npole3b,pnum,
...
c            t3=mpi_Wtime()
c            call system_clock(t3,clock_rate)
      call ereal1d_3b_1bclustPolarPermtest(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
c            call system_clock(t4,clock_rate)
c       tot_time =  (t4-t3)/real(clock_rate)
c            t4=mpi_Wtime()
...
c
c
      subroutine ereal1d_3b_1bclustPolarPermtest(npole3b,pnum,uind,uinp,
...
c
c
      subroutine emrecip1_3b_PolarPermtest(npole3b,pnum,uind,uinp,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      use sizes
      use atoms
      use bound
