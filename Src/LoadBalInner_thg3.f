...
c
C 1ST,2nd TERM W/ SCREENING
c
            fact1=0.5d0*bn(2)
            gfi(2) = -ck*bn(1) + sc(4)*bn(2) - sc(6)*bn(3)
            fact2=0.5d0*gfi(2)
            t2xxd = t2xxd + fact1*xr*(ck*xr + dk(1))+fact2
            t2xyd = t2xyd + fact1*xr*(ck*yr + dk(2))
            t2xzd = t2xzd + fact1*xr*(ck*zr + dk(3))
            t2yxd = t2yxd + fact1*yr*(ck*xr + dk(1))
            t2yyd = t2yyd + fact1*yr*(ck*yr + dk(2))+fact2
            t2yzd = t2yzd + fact1*yr*(ck*zr + dk(3))
            t2zxd = t2zxd + fact1*zr*(ck*xr + dk(1))
            t2zyd = t2zyd + fact1*zr*(ck*yr + dk(2))
            t2zzd = t2zzd + fact1*zr*(ck*zr + dk(3))+fact2
c
C 1st, 5TH TERM W SCREENING
c
            fact1=0.5d0*bn(3)
            fact2=0.5d0*bn(2)
            t2xxd = t2xxd + fact1*(-sc(4)*xr*xr)+fact2*dk(1)*xr
            t2xyd = t2xyd + fact1*(-sc(4)*xr*yr)+fact2*dk(1)*yr
            t2xzd = t2xzd + fact1*(-sc(4)*xr*zr)+fact2*dk(1)*zr
            t2yxd = t2yxd + fact1*(-sc(4)*yr*xr)+fact2*dk(2)*xr
            t2yyd = t2yyd + fact1*(-sc(4)*yr*yr)+fact2*dk(2)*yr
            t2yzd = t2yzd + fact1*(-sc(4)*yr*zr)+fact2*dk(2)*zr
            t2zxd = t2zxd + fact1*(-sc(4)*zr*xr)+fact2*dk(3)*xr
            t2zyd = t2zyd + fact1*(-sc(4)*zr*yr)+fact2*dk(3)*yr
            t2zzd = t2zzd + fact1*(-sc(4)*zr*zr)+fact2*dk(3)*zr
c         
C 1st, 6th, and 8TH TERM W SCREENING
c
            fact1=0.5d0*bn(4)*sc(6)
            t2xxd = t2xxd - bn(3)*(qkr(1)*xr+qkr(1)*xr)+bn(2)*qk(1)
     &            +fact1*xr*xr
            t2xyd = t2xyd - bn(3)*(qkr(2)*xr+qkr(1)*yr)+bn(2)*qk(4)
     &             +fact1*yr*xr
            t2xzd = t2xzd - bn(3)*(qkr(3)*xr+qkr(1)*zr)+bn(2)*qk(7)
     &              +fact1*zr*xr
            t2yxd = t2yxd - bn(3)*(qkr(1)*yr+qkr(2)*xr)+bn(2)*qk(2)
     &              +fact1*xr*yr
            t2yyd = t2yyd - bn(3)*(qkr(2)*yr+qkr(2)*yr)+bn(2)*qk(5)
     &              +fact1*yr*yr
            t2yzd = t2yzd - bn(3)*(qkr(3)*yr+qkr(2)*zr)+bn(2)*qk(8)
     &              +fact1*zr*yr
            t2zxd = t2zxd - bn(3)*(qkr(1)*zr+qkr(3)*xr)+bn(2)*qk(3)
     &              +fact1*xr*zr
            t2zyd = t2zyd - bn(3)*(qkr(2)*zr+qkr(3)*yr)+bn(2)*qk(6)
     &              +fact1*yr*zr
            t2zzd = t2zzd - bn(3)*(qkr(3)*zr+qkr(3)*zr)+bn(2)*qk(9)
     &              +fact1*zr*zr
            ...
            t2zzp = t2zzd
c
C 1st,3RD TERM W SCREENING
c
            fact1=0.5d0*bn(2)
            gfi(3) = ci*bn(1) + sc(3)*bn(2) + sc(5)*bn(3)
            fact2=0.5d0*gfi(3)
            t1xxd = t1xxd - fact1*xr*(ci*xr - di(1))+fact2
            t1xyd = t1xyd - fact1*xr*(ci*yr - di(2))
            t1xzd = t1xzd - fact1*xr*(ci*zr - di(3))
            t1yxd = t1yxd - fact1*yr*(ci*xr - di(1))
            t1yyd = t1yyd - fact1*yr*(ci*yr - di(2))+fact2
            t1yzd = t1yzd - fact1*yr*(ci*zr - di(3))
            t1zxd = t1zxd - fact1*zr*(ci*xr - di(1))
            t1zyd = t1zyd - fact1*zr*(ci*yr - di(2))
            t1zzd = t1zzd - fact1*zr*(ci*zr - di(3))+fact2
c
C 1st, 4TH TERM W SCREENING
c
            fact1=0.5d0*bn(3)
            fact2=0.5d0*bn(2)
            t1xxd = t1xxd + fact1*(-sc(3)*xr*xr)+fact2*di(1)*xr
            t1xyd = t1xyd + fact1*(-sc(3)*xr*yr)+fact2*di(1)*yr
            t1xzd = t1xzd + fact1*(-sc(3)*xr*zr)+fact2*di(1)*zr
            t1yxd = t1yxd + fact1*(-sc(3)*yr*xr)+fact2*di(2)*xr
            t1yyd = t1yyd + fact1*(-sc(3)*yr*yr)+fact2*di(2)*yr
            t1yzd = t1yzd + fact1*(-sc(3)*yr*zr)+fact2*di(2)*zr
            t1zxd = t1zxd + fact1*(-sc(3)*zr*xr)+fact2*di(3)*xr
            t1zyd = t1zyd + fact1*(-sc(3)*zr*yr)+fact2*di(3)*yr
            t1zzd = t1zzd + fact1*(-sc(3)*zr*zr)+fact2*di(3)*zr
c 
C 1st, 6th and 7TH TERM W SCREENING
c
            fact1=0.5d0*bn(4)*sc(5)
            t1xxd = t1xxd + bn(3)*(qir(1)*xr+qir(1)*xr)-bn(2)*qi(1)
     &              -fact1*xr*xr
            t1xyd = t1xyd + bn(3)*(qir(2)*xr+qir(1)*yr)-bn(2)*qi(4)
     &              -fact1*yr*xr
            t1xzd = t1xzd + bn(3)*(qir(3)*xr+qir(1)*zr)-bn(2)*qi(7)
     &              -fact1*zr*xr
            t1yxd = t1yxd + bn(3)*(qir(1)*yr+qir(2)*xr)-bn(2)*qi(2)
     &              -fact1*xr*yr
            t1yyd = t1yyd + bn(3)*(qir(2)*yr+qir(2)*yr)-bn(2)*qi(5)
     &              -fact1*yr*yr
            t1yzd = t1yzd + bn(3)*(qir(3)*yr+qir(2)*zr)-bn(2)*qi(8)
     &               -fact1*zr*yr
            t1zxd = t1zxd + bn(3)*(qir(1)*zr+qir(3)*xr)-bn(2)*qi(3)
     &               -fact1*xr*zr
            t1zyd = t1zyd + bn(3)*(qir(2)*zr+qir(3)*yr)-bn(2)*qi(6)
     &               -fact1*yr*zr
            t1zzd = t1zzd + bn(3)*(qir(3)*zr+qir(3)*zr)-bn(2)*qi(9)
     &               -fact1*zr*zr
...
c
            ...
            t2xxd = t2xxd + fact1*xr*(ck*xr + dk(1)) - 0.5d0*gfri_d(2)
            t2xxp = t2xxp + fact2*xr*(ck*xr + dk(1)) - 0.5d0*gfri_p(2)
            t2xyd = t2xyd + fact1*xr*(ck*yr + dk(2))
            ...
            t2yyd = t2yyd + fact1*yr*(ck*yr + dk(2)) - 0.5d0*gfri_d(2)
            t2yyp = t2yyp + fact2*yr*(ck*yr + dk(2)) - 0.5d0*gfri_p(2)
            t2yzd = t2yzd + fact1*yr*(ck*zr + dk(3))
            ...
            t2zzd = t2zzd + fact1*zr*(ck*zr + dk(3)) - 0.5d0*gfri_d(2)
            t2zzp = t2zzp + fact2*zr*(ck*zr + dk(3)) - 0.5d0*gfri_p(2)
c       
C 1st, 3RD TERM W/OUT SCREENING
c
            gfri_d(3) =  rr3*ci*dsc3 + rr5*sc(3)*dsc5 + rr7*sc(5)*dsc7
            gfri_p(3) =  rr3*ci*psc3 + rr5*sc(3)*psc5 + rr7*sc(5)*psc7
            t1xxd = t1xxd - fact1*xr*(ci*xr - di(1)) - 0.5d0*gfri_d(3)
            t1xxp = t1xxp - fact2*xr*(ci*xr - di(1)) - 0.5d0*gfri_p(3)
            t1xyd = t1xyd - fact1*xr*(ci*yr - di(2))
            ...
            t1yyd = t1yyd - fact1*yr*(ci*yr - di(2)) - 0.5d0*gfri_d(3)
            t1yyp = t1yyp - fact2*yr*(ci*yr - di(2)) - 0.5d0*gfri_p(3)
            t1yzd = t1yzd - fact1*yr*(ci*zr - di(3))
            ...
            t1zzd = t1zzd - fact1*zr*(ci*zr - di(3)) - 0.5d0*gfri_d(3)
            t1zzp = t1zzp - fact2*zr*(ci*zr - di(3)) - 0.5d0*gfri_p(3)
c       
C 1st, 7th TERM W/OUT SCREENING
c
            fact1=0.5d0*rr7*dsc5*sc(3)
            fact2=0.5d0*rr7*psc5*sc(3)
            fact3=-0.5d0*rr9*dsc7*sc(5)
            fact4=-0.5d0*rr9*psc7*sc(5)
            t1xxd = t1xxd - rr7*qir(1)*(xr*dsc5+xr*dsc7) 
     &              + (fact1-fact3)*xr*xr
            t1xxp = t1xxp - rr7*qir(1)*(xr*psc5+xr*psc7) 
     &              + (fact2-fact4)*xr*xr
            t1xyd = t1xyd - rr7*qir(2)*(xr*dsc5+yr*dsc7) 
     &              + (fact1-fact3)*xr*yr
            t1xyp = t1xyp - rr7*qir(2)*(xr*psc5+yr*psc7) 
     &              + (fact2-fact4)*xr*yr
            t1xzd = t1xzd - rr7*qir(3)*(xr*dsc5+zr*dsc7) 
     &              + (fact1-fact3)*xr*zr
            t1xzp = t1xzp - rr7*qir(3)*(xr*psc5+zr*psc7) 
     &              + (fact2-fact4)*xr*zr
            t1yxd = t1yxd - rr7*qir(1)*(yr*dsc5+xr*dsc7) 
     &              + (fact1-fact3)*yr*xr
            t1yxp = t1yxp - rr7*qir(1)*(yr*psc5+xr*psc7) 
     &              + (fact2-fact4)*yr*xr
            t1yyd = t1yyd - rr7*qir(2)*(yr*dsc5+yr*dsc7) 
     &              + (fact1-fact3)*yr*yr
            t1yyp = t1yyp - rr7*qir(2)*(yr*psc5+yr*psc7) 
     &              + (fact2-fact4)*yr*yr
            t1yzd = t1yzd - rr7*qir(3)*(yr*dsc5+zr*dsc7) 
     &              + (fact1-fact3)*yr*zr
            t1yzp = t1yzp - rr7*qir(3)*(yr*psc5+zr*psc7) 
     &              + (fact2-fact4)*yr*zr
            t1zxd = t1zxd - rr7*qir(1)*(zr*dsc5+xr*dsc7) 
     &              + (fact1-fact3)*zr*xr
            t1zxp = t1zxp - rr7*qir(1)*(zr*psc5+xr*psc7) 
     &              + (fact2-fact4)*zr*xr
            t1zyd = t1zyd - rr7*qir(2)*(zr*dsc5+yr*dsc7) 
     &              + (fact1-fact3)*zr*yr
            t1zyp = t1zyp - rr7*qir(2)*(zr*psc5+yr*psc7) 
     &              + (fact2-fact4)*zr*yr
            t1zzd = t1zzd - rr7*qir(3)*(zr*dsc5+zr*dsc7) 
     &              + (fact1-fact3)*zr*zr
            t1zzp = t1zzp - rr7*qir(3)*(zr*psc5+zr*psc7) 
     &              + (fact2-fact4)*zr*zr
c
C 1st and 8TH TERM W/OUT SCREENING
c
            fact1=0.5d0*rr7*dsc5*sc(4)
            fact2=0.5d0*rr7*psc5*sc(4)    
            fact3=-0.5d0*rr9*dsc7*sc(6)
            fact4=-0.5d0*rr9*psc7*sc(6)
            t2xxd = t2xxd + rr7*qkr(1)*(xr*dsc5+xr*dsc7) 
     &               + (fact1+fact3)*xr*xr
            t2xxp = t2xxp + rr7*qkr(1)*(xr*psc5+xr*psc7) 
     &               + (fact2+fact4)*xr*xr
            t2xyd = t2xyd + rr7*qkr(2)*(xr*dsc5+yr*dsc7) 
     &               + (fact1+fact3)*xr*yr
            t2xyp = t2xyp + rr7*qkr(2)*(xr*psc5+yr*psc7) 
     &               + (fact2+fact4)*xr*yr
            t2xzd = t2xzd + rr7*qkr(3)*(xr*dsc5+zr*dsc7) 
     &               + (fact1+fact3)*xr*zr
            t2xzp = t2xzp + rr7*qkr(3)*(xr*psc5+zr*psc7) 
     &                + (fact2+fact4)*xr*zr
            t2yxd = t2yxd + rr7*qkr(1)*(yr*dsc5+xr*dsc7) 
     &                + (fact1+fact3)*yr*xr
            t2yxp = t2yxp + rr7*qkr(1)*(yr*psc5+xr*psc7) 
     &                + (fact2+fact4)*yr*xr
            t2yyd = t2yyd + rr7*qkr(2)*(yr*dsc5+yr*dsc7) 
     &                + (fact1+fact3)*yr*yr
            t2yyp = t2yyp + rr7*qkr(2)*(yr*psc5+yr*psc7) 
     &                + (fact2+fact4)*yr*yr
            t2yzd = t2yzd + rr7*qkr(3)*(yr*dsc5+zr*dsc7) 
     &                + (fact1+fact3)*yr*zr
            t2yzp = t2yzp + rr7*qkr(3)*(yr*psc5+zr*psc7) 
     &                + (fact2+fact4)*yr*zr
            t2zxd = t2zxd + rr7*qkr(1)*(zr*dsc5+xr*dsc7) 
     &                + (fact1+fact3)*zr*xr
            t2zxp = t2zxp + rr7*qkr(1)*(zr*psc5+xr*psc7) 
     &                + (fact2+fact4)*zr*xr
            t2zyd = t2zyd + rr7*qkr(2)*(zr*dsc5+yr*dsc7) 
     &                + (fact1+fact3)*zr*yr
            t2zyp = t2zyp + rr7*qkr(2)*(zr*psc5+yr*psc7) 
     &                + (fact2+fact4)*zr*yr
            t2zzd = t2zzd + rr7*qkr(3)*(zr*dsc5+zr*dsc7) 
     &                + (fact1+fact3)*zr*zr
            t2zzp = t2zzp + rr7*qkr(3)*(zr*psc5+zr*psc7) 
     &                + (fact2+fact4)*zr*zr
c       
C 4TH and 6th TERM W/OUT SCREENING
c
            fact1=-0.5d0*rr5*dsc5
            fact2=-0.5d0*rr5*psc5
            t1xxd = t1xxd + fact1*(di(1)*xr-2.0d0*qi(1))
            t1xxp = t1xxp + fact2*(di(1)*xr-2.0d0*qi(1))
            t1xyd = t1xyd + fact1*(di(1)*yr-2.0d0*qi(4))
            t1xyp = t1xyp + fact2*(di(1)*yr-2.0d0*qi(4))
            t1xzd = t1xzd + fact1*(di(1)*zr-2.0d0*qi(7))
            t1xzp = t1xzp + fact2*(di(1)*zr-2.0d0*qi(7))
            t1yxd = t1yxd + fact1*(di(2)*xr-2.0d0*qi(2))
            t1yxp = t1yxp + fact2*(di(2)*xr-2.0d0*qi(2))
            t1yyd = t1yyd + fact1*(di(2)*yr-2.0d0*qi(5))
            t1yyp = t1yyp + fact2*(di(2)*yr-2.0d0*qi(5))
            t1yzd = t1yzd + fact1*(di(2)*zr-2.0d0*qi(8))
            t1yzp = t1yzp + fact2*(di(2)*zr-2.0d0*qi(8))
            t1zxd = t1zxd + fact1*(di(3)*xr-2.0d0*qi(3))
            t1zxp = t1zxp + fact2*(di(3)*xr-2.0d0*qi(3))
            t1zyd = t1zyd + fact1*(di(3)*yr-2.0d0*qi(6))
            t1zyp = t1zyp + fact2*(di(3)*yr-2.0d0*qi(6))
            t1zzd = t1zzd + fact1*(di(3)*zr-2.0d0*qi(9))
            t1zzp = t1zzp + fact2*(di(3)*zr-2.0d0*qi(9))
c         
C 5TH and 6th TERM W/OUT SCREENING
c
            fact1=-0.5d0*rr5*dsc5
            fact2=-0.5d0*rr5*psc5
            t2xxd = t2xxd + fact1*(dk(1)*xr+2.0d0*qk(1))
            t2xxp = t2xxp + fact2*(dk(1)*xr+2.0d0*qk(1))
            t2xyd = t2xyd + fact1*(dk(1)*yr+2.0d0*qk(4))
            t2xyp = t2xyp + fact2*(dk(1)*yr+2.0d0*qk(4))
            t2xzd = t2xzd + fact1*(dk(1)*zr+2.0d0*qk(7))
            t2xzp = t2xzp + fact2*(dk(1)*zr+2.0d0*qk(7))
            t2yxd = t2yxd + fact1*(dk(2)*xr+2.0d0*qk(2))
            t2yxp = t2yxp + fact2*(dk(2)*xr+2.0d0*qk(2))
            t2yyd = t2yyd + fact1*(dk(2)*yr+2.0d0*qk(5))
            t2yyp = t2yyp + fact2*(dk(2)*yr+2.0d0*qk(5))
            t2yzd = t2yzd + fact1*(dk(2)*zr+2.0d0*qk(8))
            t2yzp = t2yzp + fact2*(dk(2)*zr+2.0d0*qk(8))
            t2zxd = t2zxd + fact1*(dk(3)*xr+2.0d0*qk(3))
            t2zxp = t2zxp + fact2*(dk(3)*xr+2.0d0*qk(3))
            t2zyd = t2zyd + fact1*(dk(3)*yr+2.0d0*qk(6))
            t2zyp = t2zyp + fact2*(dk(3)*yr+2.0d0*qk(6))
            t2zzd = t2zzd + fact1*(dk(3)*zr+2.0d0*qk(9))
            t2zzp = t2zzp + fact2*(dk(3)*zr*2.0d0*qk(9))
c
...
c
            ...
            fact3=0.5d0*rr7*dscale(kk)*sc(6)
            fact4=0.5d0*rr7*pscale(kk)*sc(6)
     ...
     &        - fact4*zr*ddsc7(3)
            ...
            fact3=0.5d0*rr7*dscale(kk)*sc(5)
            fact4=0.5d0*rr7*pscale(kk)*sc(5)
...
c
            ...
            fact3=rr5*dscale(kk)
            fact4=rr5*pscale(kk)
            t1xxd = t1xxd - ddsc5(1)*(fact1*xr + fact3*qir(1))
            t1xxp = t1xxp - ddsc5(1)*(fact2*xr + fact4*qir(1))
            t1xyd = t1xyd - ddsc5(1)*(fact1*yr + fact3*qir(2))
            t1xyp = t1xyp - ddsc5(1)*(fact2*yr + fact4*qir(2))
            t1xzd = t1xzd - ddsc5(1)*(fact1*zr + fact3*qir(3))
            t1xzp = t1xzp - ddsc5(1)*(fact2*zr + fact4*qir(3))
            t1yxd = t1yxd - ddsc5(2)*(fact1*xr + fact3*qir(1))
            t1yxp = t1yxp - ddsc5(2)*(fact2*xr + fact4*qir(1))
            t1yyd = t1yyd - ddsc5(2)*(fact1*yr + fact3*qir(2))
            t1yyp = t1yyp - ddsc5(2)*(fact2*yr + fact4*qir(2))
            t1yzd = t1yzd - ddsc5(2)*(fact1*zr + fact3*qir(3))
            t1yzp = t1yzp - ddsc5(2)*(fact2*zr + fact4*qir(3))
            t1zxd = t1zxd - ddsc5(3)*(fact1*xr + fact3*qir(1))
            t1zxp = t1zxp - ddsc5(3)*(fact2*xr + fact4*qir(1))
            t1zyd = t1zyd - ddsc5(3)*(fact1*yr + fact3*qir(2))
            t1zyp = t1zyp - ddsc5(3)*(fact2*yr + fact4*qir(2))
            t1zzd = t1zzd - ddsc5(3)*(fact1*zr + fact3*qir(3))
            t1zzp = t1zzp - ddsc5(3)*(fact2*zr + fact4*qir(3))
       
            fact1=0.5d0*rr5*dscale(kk)*sc(4)
            fact2=0.5d0*rr5*pscale(kk)*sc(4)
            t2xxd = t2xxd + ddsc5(1)*(fact1*xr + fact3*qkr(1))
            t2xxp = t2xxp + ddsc5(1)*(fact2*xr + fact4*qkr(1))
            t2xyd = t2xyd + ddsc5(1)*(fact1*yr + fact3*qkr(2))
            t2xyp = t2xyp + ddsc5(1)*(fact2*yr + fact4*qkr(2))
            t2xzd = t2xzd + ddsc5(1)*(fact1*zr + fact3*qkr(3))
            t2xzp = t2xzp + ddsc5(1)*(fact2*zr + fact4*qkr(3))
            t2yxd = t2yxd + ddsc5(2)*(fact1*xr + fact3*qkr(1))
            t2yxp = t2yxp + ddsc5(2)*(fact2*xr + fact4*qkr(1))
            t2yyd = t2yyd + ddsc5(2)*(fact1*yr + fact3*qkr(2))
            t2yyp = t2yyp + ddsc5(2)*(fact2*yr + fact4*qkr(2))
            t2yzd = t2yzd + ddsc5(2)*(fact1*zr + fact3*qkr(3))
            t2yzp = t2yzp + ddsc5(2)*(fact2*zr + fact4*qkr(3))
            t2zxd = t2zxd + ddsc5(3)*(fact1*xr + fact3*qkr(1))
            t2zxp = t2zxp + ddsc5(3)*(fact2*xr + fact4*qkr(1))
            t2zyd = t2zyd + ddsc5(3)*(fact1*yr + fact3*qkr(2))
            t2zyp = t2zyp + ddsc5(3)*(fact2*yr + fact4*qkr(2))
            t2zzd = t2zzd + ddsc5(3)*(fact1*zr + fact3*qkr(3))
            t2zzp = t2zzp + ddsc5(3)*(fact2*zr + fact4*qkr(3))
c
