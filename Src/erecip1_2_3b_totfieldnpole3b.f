      ...
      subroutine erecip1_2_3b_totfieldnpole3b(npole3b,pnum,uind,uinp,
     & deptemp,virtemp)
c      implicit none
c      include 'sizes.i'
c      include 'atoms.i'
...
c                     end if
     ...
     &              !                           -ckr(l1)*(t3+t3p))
                    ! det2i =expterm*(ckr(l1)*(t4+t4p)+skr(l1)*(t3+t3p))
                      ...
                      det1i = 0.5d0 * expterm * (skr(i)*(t4p)
     &                                         -ckr(i)*(t3p))
                      det2i =expterm*(ckr(i)*(t4p)+skr(i)*(t3p))
