      ...
      subroutine LoadBalNew2SmoothInnerloop1_2cut_wskin1bmut_half(
...
c        moli1=molnew(kouter)
      do moli1=start_polar(taskid_offset),last_polar(taskid_offset)
...
C
     ...
     & !          deptemp,virtemp)
      call empole1a_3b_Polar_new_subtract_1bodymut(npole3b,pnum,
     &   eptemp,deptemp,virtemp,2) 
          ep2moli12=eptemp
          do l1 = 1, npole3b
            i = pnum(l1)
            do j = 1, 3
