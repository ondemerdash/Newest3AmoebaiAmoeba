...
c     &   eptemp,deptemp,virtemp)
      subroutine ereal1d2_3b_totfieldnpole_511offset(offset,npole3b,
...
c
     ...
     &            pscale(i14(j,ii)) = p4scale * p41scale
         ...
         !do kkk = 1, nelst(i)
         !   k = elst(kkk,i)
         do kkk = 1, nembedlst(l3)
            k = embedlst(kkk,l3)
c         do l2 = l1+1, npole3b
         !do l2 =1,npole3b
         !   k=pnum(l2)
            dok=.false.
            do k1=offset+1,npole3b
...
!$OMP END PARALLEL
      ...
      !      k=embedlst(kk,l1)
      !      do j = 1, 3
      !       deptemp(j,k) = deptemp(j,k) + dept1(j,k) + dept2(j,k)
      !      end do
      !   end do
      end do
      do i = 1, 3
