c
      subroutine totfieldNpoleloadbalsmoothInner_1c_3bPolar_dEtensorMpi
     &  (ep3bt,virep3bt,dep3bt)
      ...
      SwitchR3b=Cobarcut3b-rtapr3b
        ...
        print*,"3BODY MODE TOTFIELD DETENSOR!!"
...
c              print*,"i j dep1moli1(j,i)",i,j,dep1moli1(j,i)
          ...
          do k2=1,nmollst(moli2)
            ...
            if ((r1.lt.r3).and.(r2.lt.r3) ) then
              ...
              if (shellsum.le.Cobarcut3b) then            
                 call Newempole1c_3b_Polar_totfield_dEtensor2(npole3b,
     ...
     &           pnum,eptemp,deptemp,virtemp)
                 ...
                 pnum(3)=imol(2,moli3)
                 call Newempole1c_3b_Polar_totfield_dEtensor2(
