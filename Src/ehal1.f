...
c
      mode = 'VDW'
      call switch (mode)
      !print*,"Beginning of ehal1a off2",off2
      !print*,"Ehal1a xcell ycell zcell",xcell,ycell,zcell
      !print*,"Ehal1a xcell2 ycell2 zcell2",xcell2,ycell2,zcell2
      !print*,"Ehal1a xbox2 ybox2 zbox2",xbox2,ybox2,zbox2
c
...
c      print*,"Ehal1c xcell ycell zcell",xcell,ycell,zcell
c      print *,"Ehal1c xcell2 ycell2 zcell2",xcell2,ycell2,zcell2
      print*,"In Ehal1c x(3) y(3) z(3)",x(3),y(3),z(3)
         off = vdwcut
         cut = vdwtaper
