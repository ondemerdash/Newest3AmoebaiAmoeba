...
c
c
      !subroutine LoadBal_ereal1d_3b_Perm_sentlist2_totfield_dEtensorOmp2
      subroutine LoadBalInner_thg4omp_mpi_72015torque2
...
c      print*,"last=",last_emreal2(taskid)
      ...
      !maxlocal = int(dble(sz)*dble(maxsize_elst(taskid)))
      nlocaltau1 = 0
      nlocaltau2 = 0
c
...
c!$OMP& tauzx2p,tauzy2p,tauzz2p,nlocal)
c!$OMP& firstprivate(mscale,pscale,dscale)

c!$OMP PARALLEL default(private) shared(demi,demk,fieldt,fieldtp,
c!$OMP& viremrealt,emrealt,npole,electric,dielec,off2,toffset,
...
c!$OMP& nelst_recv,elst_recv,xaxis,yaxis,zaxis,f,aewald,
c!$OMP& start_emreal2,last_emreal2,taskid)
c!$OMP& firstprivate(pscale,dscale,mscale,nlocal,nlocaltau1,
c!$OMP& nlocaltau2)
      ...
      allocate (taulocal1d(9,maxlocal))
      allocate (taulocal2d(9,maxlocal))
      allocate (taulocal1p(9,maxlocal))
      allocate (taulocal2p(9,maxlocal)) 
      allocate (ilocaltau1(2,maxlocal))
      allocate (ilocaltau2(2,maxlocal))
       !  do m=1,maxlocal
       !     do j=1,9
       !        dlocal1d(j,m)=0.0d0
       !        dlocal1p(j,m)=0.0d0
       !        dlocal2d(j,m)=0.0d0
       !        dlocal2p(j,m)=0.0d0
       !        taulocal1d(j,m)=0.0d0
       !        taulocal2d(j,m)=0.0d0
       !        taulocal1p(j,m)=0.0d0
       !        taulocal2p(j,m)=0.0d0
       !     end do
       !  end do
...
c             do m=1,nlocal
c                if( (ilocal(1,m).eq.i) .and. (ilocal(2,m).eq.k)) then
c                  done_ik=.true.
c                  ik=m
c                  goto 31
c                end if
...
c             else
c             dlocal1d(1,ik)=dlocal1d(1,ik)+t1xxd
c             dlocal1d(2,ik)=dlocal1d(2,ik)+t1xyd
c             dlocal1d(3,ik)=dlocal1d(3,ik)+t1xzd
c             dlocal1d(4,ik)=dlocal1d(4,ik)+t1yxd
c             dlocal1d(5,ik)=dlocal1d(5,ik)+t1yyd
c             dlocal1d(6,ik)=dlocal1d(6,ik)+t1yzd
c             dlocal1d(7,ik)=dlocal1d(7,ik)+t1zxd
c             dlocal1d(8,ik)=dlocal1d(8,ik)+t1zyd
c             dlocal1d(9,ik)=dlocal1d(9,ik)+t1zzd
c
c             dlocal2d(1,ik)=dlocal2d(1,ik)+t2xxd
c             dlocal2d(2,ik)=dlocal2d(2,ik)+t2xyd
c             dlocal2d(3,ik)=dlocal2d(3,ik)+t2xzd
c             dlocal2d(4,ik)=dlocal2d(4,ik)+t2yxd
c             dlocal2d(5,ik)=dlocal2d(5,ik)+t2yyd
c             dlocal2d(6,ik)=dlocal2d(6,ik)+t2yzd
c             dlocal2d(7,ik)=dlocal2d(7,ik)+t2zxd
c             dlocal2d(8,ik)=dlocal2d(8,ik)+t2zyd
c             dlocal2d(9,ik)=dlocal2d(9,ik)+t2zzd
c
c             dlocal1p(1,ik)=dlocal1p(1,ik)+t1xxp
c             dlocal1p(2,ik)=dlocal1p(2,ik)+t1xyp
c             dlocal1p(3,ik)=dlocal1p(3,ik)+t1xzp
c             dlocal1p(4,ik)=dlocal1p(4,ik)+t1yxp
c             dlocal1p(5,ik)=dlocal1p(5,ik)+t1yyp
c             dlocal1p(6,ik)=dlocal1p(6,ik)+t1yzp
c             dlocal1p(7,ik)=dlocal1p(7,ik)+t1zxp
c             dlocal1p(8,ik)=dlocal1p(8,ik)+t1zyp
c             dlocal1p(9,ik)=dlocal1p(9,ik)+t1zzp
c
c             dlocal2p(1,ik)=dlocal1p(1,ik)+t2xxp
c             dlocal2p(2,ik)=dlocal1p(2,ik)+t2xyp
c             dlocal2p(3,ik)=dlocal1p(3,ik)+t2xzp
c             dlocal2p(4,ik)=dlocal1p(4,ik)+t2yxp
c             dlocal2p(5,ik)=dlocal1p(5,ik)+t2yyp
c             dlocal2p(6,ik)=dlocal1p(6,ik)+t2yzp
c             dlocal2p(7,ik)=dlocal1p(7,ik)+t2zxp
c             dlocal2p(8,ik)=dlocal1p(8,ik)+t2zyp
c             dlocal2p(9,ik)=dlocal1p(9,ik)+t2zzp
c             end if
...
c
     ...
     &         ! dlocal1p,dlocal2d,dlocal2p,k)
            !call torque3_dEtensor_72015_pt1(i,ttm2,ttm2i,frcxi,frcyi,
     &      !    frczi,demi,fkmd,fkmp,nlocal,ilocal,dlocal1d,
     &      !     dlocal1p,dlocal2d,dlocal2p,k)

            !call torque3_dEtensor_72015_dE1only_pt1(i,ttm2,ttm2i,
     &      ! frcxi,frcyi,frczi,demi,fkmd,fkmp,nlocal,ilocal,dlocal1d,
     &      !     dlocal1p,k)
         !  call torque3_dEtensor_72015_tau_pt1(i,ttm2,ttm2i,frcxi,frcyi,
     &   !     frczi,demi,fkmd,fkmp,nlocal,ilocal,taulocal1d,
     &   !     taulocal1p,taulocal2d,taulocal2p,k)
           !call torque3_dEtensor_72015_taunew_pt1(i,ttm2,ttm2i,frcxi,
     &     !frcyi,frczi,demi,fkmd,fkmp,nlocaltau1,ilocaltau1,taulocal1d,
     &     !   taulocal1p,k)
...
c
     ...
     &        !  dlocal1p,dlocal2d,dlocal2p,k)
          ! call torque3_dEtensor_72015_pt2(i,ttm3,ttm3i,frcxk,frcyk,
     &    !      frczk,demk,fimd,fimp,nlocal,ilocal,dlocal1d,
     &    !       dlocal1p,dlocal2d,dlocal2p,k)
          ! call torque3_dEtensor_72015_dE2only_pt2(i,ttm3,ttm3i,
     &    !      frcxk,frcyk,frczk,demk,fimd,fimp,nlocal,ilocal,
     &    !      dlocal2d,dlocal2p,k)
          ! call torque3_dEtensor_72015_tau_pt2(i,ttm3,ttm3i,frcxk,frcyk,
     &    !      frczk,demk,fimd,fimp,nlocal,ilocal,taulocal1d,
     &    !       taulocal1p,taulocal2d,taulocal2p,k)
           !call torque3_dEtensor_72015_taunew_pt2(i,ttm3,ttm3i,frcxk,
     &     !  frcyk,frczk,demk,fimd,fimp,nlocaltau2,ilocaltau2,
