...
c
c
      program dEtensorewtotfield_dyn_rMPIOMP_kMPIBcast_rloadbal_vMPIOMP
      use sizes
      use atoms
      use bath
      use bndstr
...
c            listsend_mpole = .false.
     ...
     &             master,mpi_comm_world,ierr)
            ...
            ! call gradient_emrecip_totfield
             ...
             call gradient_emrecip_totfield_mpi_fphimpole
...
c            listsend_mpole=.false.
            call mpi_bcast(em,1,mpi_real8,master,
     &       mpi_comm_world,ierr)
           call mpi_bcast(dem,3*n,mpi_real8,master,
     &       mpi_comm_world,ierr)
           call mpi_bcast(viremrecip,3*3,mpi_real8,master,
     &       mpi_comm_world,ierr)
