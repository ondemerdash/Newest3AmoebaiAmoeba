...
c
c
      subroutine emrecip1_1and2_3b_Polar_totfield(npole3b,pnum,uind,
...
c     &                 + fuinp(k,i)*fphid(j3,i)
     ...
     &          !       + fuinp(k,l1)*fphid(j3,l1)
               if(doi) then
               e = e + fuind(k,l1)*fphi(k+1,i)
               f1 = f1 + (fuind(k,l1)+fuinp(k,l1))*fphi(j1,i)
     &                 + fuind(k,l1)*fphip(j1,i)
     &                 + fuinp(k,l1)*fphid(j1,i)
               f2 = f2 + (fuind(k,l1)+fuinp(k,l1))*fphi(j2,i)
     &                 + fuind(k,l1)*fphip(j2,i)
     &                 + fuinp(k,l1)*fphid(j2,i)
               f3 = f3 + (fuind(k,l1)+fuinp(k,l1))*fphi(j3,i)
