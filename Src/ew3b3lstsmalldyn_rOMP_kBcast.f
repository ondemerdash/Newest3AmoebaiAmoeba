...
c            listsend_mpole=.false.
     ...
     &                 + deopb(j,i) + det(j,i) + dept(j,i) + dett(j,i)
            ...
            if(taskid.eq.master) then
              ...
              call mollist3bodycobarPar
              call polar_load_balance3b_sizelist
              call gradient_setup    
              allocate (derivs(3,n))
              call prep_pole
              print*,"listbcast=",listbcast
...
c            print*,"After all 2body list bcast"
            ...
            if(listbcast3b) then
              call bcast_polar_load_balance3b

              call sendmollst3_load_balanced_sizelist
              print*,"After 3BODY SEND/RECV" 
            end if
            listbcast3b = .false.
...
c            call smallsmooth2_gradient_polar_load_balanced 
           call ewsmallsmooth2body_gradient_polar_load_balanced
           call ewsmallsmooth3body_gradient_polar_load_balanced
