...
c
c
      subroutine LoadBalInnerloop_ereal1d_sentlist2(ep3bt,dep3bt,
     & emrealt,demrealt,viremrealt)
      use mpidat 
      use sizes
      use atoms
      use bound
      ...
      real*8 ep3bt,dep3bt(3,*),demrealt(3,*),emrealt,viremrealt(3,3)
      logical dorl,dorli
      character*6 mode
      integer iter3
      external erfc
...
c      print*,"In LoadBal_ereal1d taskid",taskid,
c     &       "start_emreal2=",start_emreal2(taskid)
c      print*,"In LoadBal_ereal1d taskid",taskid,
c    &       "last_emreal2=",last_emreal2(taskid)
c
...
!$OMP& gfr,gfri,gti,gtri,dorl,dorli,iter3)
!$OMP& firstprivate(mscale,pscale,dscale)
!$OMP DO reduction(+:emo,epo,demo1,demo2,depo1,depo2,viro)
!$OMP& schedule(guided)
c
...
c
      ...
      do i = 1, n
         do j = 1, 3
            demrealt(j,i) =  demo1(j,i) + demo2(j,i)
            dep3bt(j,i) =  depo1(j,i) + depo2(j,i)
         end do
      end do
      do i = 1, 3
         do j = 1, 3
            viremrealt(j,i) = viro(j,i)
         end do
      end do
c      print*,"In LoadBal_ereal1d taskid=",taskid,"emrealt=",emrealt
c      print*,"In LoadBal_ereal1d taskid=",taskid,"ep3bt=",ep3bt
