...
c     &   eptemp,deptemp,virtemp)
      subroutine ereal1d2_3b_totfieldnpole_mlist(
     &  eptemp,deptemp,virtemp)
      ...
      integer kkk
C      integer nembedlst(npole3b),embedlst(maxelst,npole3b)
      logical dorli
      external erfc
