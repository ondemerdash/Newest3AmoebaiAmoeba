      ...
      subroutine ClustEmpole1_1b_NoOmp 
...
c        allocate(dep2moli12(3,3*3*maxsizeclust))
        allocate(deptemp(3,3*maxsizeclust))
        allocate(demtemp(3,3*maxsizeclust))
...
c          print*,"B4empole1c_3b_PolarPerm in 1b"
          call empole1c_3b_PolarPerm(npole3b,pnum,
     &         eptemp,deptemp,virtemp,cnt,emtemp,demtemp)
c         else
c          call empole1b_3b_Polar_orig_nopriordiromp1b(npole3b,pnum,
c     &         eptemp,deptemp,virtemp,cnt)
c         end if
          ep3bt = ep3bt + eptemp
          em3bt = em3bt + emtemp
          ...
          do l1 = 1, npole3b
             ...
             do j = 1, 3
              ...
              dem3bt(j,i) = dem3bt(j,i)+demtemp(j,l1)
              dem1btmat(j,l1,clust1)=demtemp(j,l1)
             end do            
          end do
          do i=1,3
            do j=1,3
...
c         end if
          ...
          do l1 = 1, npole3b
             ...
             do j = 1, 3
              ...
              dem3bt(j,i) = dem3bt(j,i)+demtemp(j,l1)
              dem1btmat(j,l1,moli1rmndr)=demtemp(j,l1)
             end do
          end do
          do i=1,3
            do j=1,3
