      subroutine clust_gradient_Polar1b2b3bsimult_ireducematcommsmall2
     & (start,
     & last,moli1rmndr)
      use mpole
      use mpidat
...
c           t5=mpi_Wtime()
           call ClustEmpole1plz_2b_NoOmplistRtrn2BmatNoSubtr1bSimult(
...
c          end if
     ...
     &    .and. (taskid.lt.(numtasks_polar+numtasks_polar1
     &         +numtasks_polar3b))) then 
           call ClustEmpole1plz_3b_NoOmplistRtrn3BNoSubtr1b2bSimult(
...
c        deallocate(dem2bt)
     ...
     &     mpi_sum,master,emreal_comm3,reqs33,ierr)
      ...
      subroutine sum_gradient_Polar1b2b3bsimult_ireducematcommsmall2
c     & (start,
c     & last,moli1rmndr)
      use mpole
      use mpidat
