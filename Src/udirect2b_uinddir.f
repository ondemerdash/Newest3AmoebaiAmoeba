...
!$OMP& elst,cut2,aewald,aesq2,aesq2n,poltyp,
!$OMP& fieldt,fieldtp,maxlocal)
...
c
      do i=1,npole
         do j=1,3
            uind(j,i)= polarity(i) * fieldt(j,i)
            uinp(j,i) = polarity(i) * fieldtp(j,i)
         end do
      end do
      print*,"Successful completion of udirect2b_uinddir"
