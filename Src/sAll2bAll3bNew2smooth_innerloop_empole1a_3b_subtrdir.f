c
      subroutine sAll2bAll3bNew2SmoothInnerloop1_2cut_wskin_subtrdir(
...
c          moli2=mollst(k1,moli1)
     ...
     &           .and.(len3.eq.5)) then
                ...
                np3=11
                 ...
                 call empole1a_3b_Polar(npole3b,pnum,
     &               eptemp,deptemp,
     &               virtemp)
                  ntript=ntript+1
                  ep3moli123=eptemp
                  ...
                  if(len1.eq.3.and.len2.eq.3) then
                    ...
                    pnum(5)=imol(1,moli2)+1
                    pnum(6)=imol(2,moli2)
                  else if((len1.eq.3).and.(len2.eq.5)) then
                    npole3b=8
                    pnum(1)=imol(1,moli1)
                    pnum(2)=imol(1,moli1)+1
                    pnum(3)=imol(2,moli1)
                    ...
                    pnum(7)=imol(1,moli2)+3
                    pnum(8)=imol(2,moli2)
                  else if((len1.eq.5).and.(len2.eq.3)) then
                    npole3b=8
                    pnum(1)=imol(1,moli1)
                    pnum(2)=imol(1,moli1)+1
                    pnum(3)=imol(1,moli1)+2
