...
c      subroutine Innerloop2(moli1,ep3bt,virep3bt,dep3bt)
      subroutine NoCutSmoothInnerloop2body_ew(ep3bt,virep3bt,dep3bt,
...
c      Rcut2b=7.0d0
      ...
      print*,"2body start last=",start,last

c!$OMP PARALLEL default(private) shared(imol,ep3bt,
c!$OMP& virep3bt,dep3bt,start,last,nmol,
c!$OMP& name,x,y,z,rtapr2b,
c!$OMP& Rcut2b,SwitchR2b,taskid,
c!$OMP& Rcut2b2)
...
c               dep2moli12(j,l1)=deptemp(j,i)
            ...
            do l1 = 1, npole3b
              ...
              l2=l1+np1
              do j = 1, 3
c               dep2moli12(j,l2)=dep2moli12(j,l2)-deptemp(j,i)
...
c      subroutine Innerloop3(iter3,moli1,ep3bt,virep3bt,dep3bt)
      subroutine NoCutSmoothInnerloop3body_ew(ep3bt,virep3bt,dep3bt,
     & ntript,start,last,moli1rmndr)  
      use sizes
      use atoms
      use atomid
      use molcul
...
c                do i=1,3
c                   do j=1,3
c                      virep3bt(i,j)=0.0d0
c                   end do
c                end do
      print*,"Begin Innerloop3"
      print*,"3body start last",start,last
      print*,"Cobarcut3b",Cobarcut3b
...
c!$OMP& schedule(guided)
     ...
     &           virtemp)
                ...
                do l1 = 1,npole3b
                  i = pnum(l1)
c                  dep3moli123(1,l1) = deptemp(1,i)
c                  dep3moli123(2,l1) = deptemp(2,i)
c                  dep3moli123(3,l1) = deptemp(3,i)
...
c                dep1moli3(j,l1)=deptemp(j,i)
          ...
          if(r1.le.Rcut2b) then
            ...
            do l1=1,np1
               i=pnum(l1)
               do j=1,3
c                  dep2moli12(j,l1)=deptemp(j,i)-dep1moli1(j,l1)
            ...
            do l1=1,np1
               ...
               i=pnum(l2)
               do j=1,3
c                  dep2moli12(j,l2)=deptemp(j,i)-dep1moli2(j,l1)
...
c                       l2=l1+np1
     ...
     &            virtemp)
            ...
            do l1=1,np1
               i=pnum(l1)
               do j=1,3
c                  dep2moli23(j,l1)=deptemp(j,i)-dep1moli2(j,l1)
            ...
            do l2=np1+1,npole3b
               ...
               i=pnum(l2)
               do j=1,3
c                  dep2moli23(j,l2)=deptemp(j,i)-dep1moli3(j,l1)
     ...
     &           virtemp)
                 ...
                 do l1=1,np1
                    i=pnum(l1)
                    do j=1,3
c                     dep2moli13(j,l1)=deptemp(j,i)-dep1moli1(j,l1)
                 ...
                 do l1=1,np1
                    ...
                    i=pnum(l2)
                    do j=1,3
c                     dep2moli13(j,l2)=deptemp(j,i)-dep1moli3(j,l1)
