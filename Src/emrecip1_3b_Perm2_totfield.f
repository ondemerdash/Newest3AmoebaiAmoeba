c
      subroutine emrecip1_3b_Perm2_totfield
      use sizes
      use atoms
      use bound
      use boxes
...
c            field(j,i) = 0.0d0
c            fieldp(j,i) = 0.0d0
c            fieldnpole(j,i) = 0.0d0
c            fieldpnpole(j,i) = 0.0d0
...
c      end do
      ...
      do i = 1, n
       ...
       !print*,"emrecip1_3b_Perm2totfield dem",dem(1,i),dem(2,i),dem(3,i)
      end do
c
...
c     perform deallocation of some local arrays
c
c      print*,"End of emrecip1_3b_Perm2totfield",em
      deallocate (frc)
      deallocate (trq)
c      deallocate (fuind)
c      deallocate (fuinp)
