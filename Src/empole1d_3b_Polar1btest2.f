      subroutine empole1d_3b_Polar1btest2(npole3b,pnum,
...
c     & eptemp,deptemp,virtemp,emtemp,demtemp) 
      ...
      call ereal1d_3b_1bclustPolartest2(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp)!,emtemp,demtemp)
...
c
c
      subroutine ereal1d_3b_1bclustPolartest2(npole3b,pnum,uind,uinp,
...
c     ##################################################################
c
      subroutine emrecip1_3b_Polartest2(npole3b,pnum,uind,uinp,
     & eptemp,deptemp,virtemp)!,emtemp,demtemp)
      use sizes
      use atoms
      use bound
