...
c
c
      subroutine grid_uind3b_totfield (npole3b,pnum,fuind,fuinp,qgrid3b,
...
c     &         fdip_phi1,fdip_phi2,fdip_sum_phi,qgrid)
      subroutine fphi_uind3b_totfield (npole3b,pnum,fdip_phi1,fdip_phi2,
