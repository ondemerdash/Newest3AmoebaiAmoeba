      ...
      subroutine ClustEmpole1_1b_NoOmplistsimult 
     &  (start,last,moli1rmndr,
     &  ep1btmat,dep1btmat,virep1btmat,em1btmat,
     &  dem1btmat) 
      use sizes
      use atoms
      use atomid
...
c              dep3bt(j,i) = dep3bt(j,i)+deptemp(j,i)
...
c        deallocate(dep1moli2)
c        deallocate(dep2moli12nosubtr)
        print*,"Clst1Btskid=",taskid,"eptemp=",eptemp
