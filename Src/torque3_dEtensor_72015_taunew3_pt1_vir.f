...
c
c
      subroutine torque3_dEtensor_72015_taunew3_pt1_vir(i,trq2,
     &  taud,taup,nlocaltau1,
     &   nlocal,
     &  k,kkk,iter3)
      use sizes
      use atoms
...
c            depi(j,ib) = depi(j,ib) - du - dv
                ...
                elsttau1_tmp(1,kkk,iter3)=nlocaltau1
...
c                taulocal1p(9,nlocaltau1)=duzz_p
                ...
                taud1tmp(1,nlocaltau1)=duxx_d
                taud1tmp(2,nlocaltau1)=duxy_d
                taud1tmp(3,nlocaltau1)=duxz_d
                taud1tmp(4,nlocaltau1)=duyx_d
                taud1tmp(5,nlocaltau1)=duyy_d
                taud1tmp(6,nlocaltau1)=duyz_d
                taud1tmp(7,nlocaltau1)=duzx_d
                taud1tmp(8,nlocaltau1)=duzy_d
                taud1tmp(9,nlocaltau1)=duzz_d
                taup1tmp(1,nlocaltau1)=duxx_p
                taup1tmp(2,nlocaltau1)=duxy_p
                taup1tmp(3,nlocaltau1)=duxz_p
                taup1tmp(4,nlocaltau1)=duyx_p
                taup1tmp(5,nlocaltau1)=duyy_p
                taup1tmp(6,nlocaltau1)=duyz_p
                taup1tmp(7,nlocaltau1)=duzx_p
                taup1tmp(8,nlocaltau1)=duzy_p
                taup1tmp(9,nlocaltau1)=duzz_p
...
c                frcztaulocal1p(9,nlocal)=duzz_p
                ...
                frcztau1d(1,nlocal)=duxx_d
                frcztau1d(2,nlocal)=duxy_d
                frcztau1d(3,nlocal)=duxz_d
                frcztau1d(4,nlocal)=duyx_d
                frcztau1d(5,nlocal)=duyy_d
                frcztau1d(6,nlocal)=duyz_d
                frcztau1d(7,nlocal)=duzx_d
                frcztau1d(8,nlocal)=duzy_d
                frcztau1d(9,nlocal)=duzz_d
                frcztau1p(1,nlocal)=duxx_p
                frcztau1p(2,nlocal)=duxy_p
                frcztau1p(3,nlocal)=duxz_p
                frcztau1p(4,nlocal)=duyx_p
                frcztau1p(5,nlocal)=duyy_p
                frcztau1p(6,nlocal)=duyz_p
                frcztau1p(7,nlocal)=duzx_p
                frcztau1p(8,nlocal)=duzy_p
                frcztau1p(9,nlocal)=duzz_p
...
c                frcxtaulocal1p(9,nlocal)=dvzz_p
                ...
                frcxtau1d(1,nlocal)=dvxx_d
                frcxtau1d(2,nlocal)=dvxy_d
                frcxtau1d(3,nlocal)=dvxz_d
                frcxtau1d(4,nlocal)=dvyx_d
                frcxtau1d(5,nlocal)=dvyy_d
                frcxtau1d(6,nlocal)=dvyz_d
                frcxtau1d(7,nlocal)=dvzx_d
                frcxtau1d(8,nlocal)=dvzy_d
                frcxtau1d(9,nlocal)=dvzz_d
                frcxtau1p(1,nlocal)=dvxx_p
                frcxtau1p(2,nlocal)=dvxy_p
                frcxtau1p(3,nlocal)=dvxz_p
                frcxtau1p(4,nlocal)=dvyx_p
                frcxtau1p(5,nlocal)=dvyy_p
                frcxtau1p(6,nlocal)=dvyz_p
                frcxtau1p(7,nlocal)=dvzx_p
                frcxtau1p(8,nlocal)=dvzy_p
                frcxtau1p(9,nlocal)=dvzz_p
...
c                frcytaulocal1p(9,nlocal)=0.0d0
                ...
                frcytau1d(1,nlocal)=0.0d0
                frcytau1d(2,nlocal)=0.0d0
                frcytau1d(3,nlocal)=0.0d0
                frcytau1d(4,nlocal)=0.0d0
                frcytau1d(5,nlocal)=0.0d0
                frcytau1d(6,nlocal)=0.0d0
                frcytau1d(7,nlocal)=0.0d0
                frcytau1d(8,nlocal)=0.0d0
                frcytau1d(9,nlocal)=0.0d0
                frcytau1p(1,nlocal)=0.0d0
                frcytau1p(2,nlocal)=0.0d0
                frcytau1p(3,nlocal)=0.0d0
                frcytau1p(4,nlocal)=0.0d0
                frcytau1p(5,nlocal)=0.0d0
                frcytau1p(6,nlocal)=0.0d0
                frcytau1p(7,nlocal)=0.0d0
                frcytau1p(8,nlocal)=0.0d0
                frcytau1p(9,nlocal)=0.0d0
...
c                ilocaltau1(2,nlocaltau1)=k
                ...
                !elsttau1_tmp(k,ia)=nlocaltau1
                elsttau1_tmp(2,kkk,iter3)=nlocaltau1
...
c                taulocal1p(9,nlocaltau1)=dvzz_p
                ...
                taud1tmp(1,nlocaltau1)=dvxx_d
                taud1tmp(2,nlocaltau1)=dvxy_d
                taud1tmp(3,nlocaltau1)=dvxz_d
                taud1tmp(4,nlocaltau1)=dvyx_d
                taud1tmp(5,nlocaltau1)=dvyy_d
                taud1tmp(6,nlocaltau1)=dvyz_d
                taud1tmp(7,nlocaltau1)=dvzx_d
                taud1tmp(8,nlocaltau1)=dvzy_d
                taud1tmp(9,nlocaltau1)=dvzz_d
                taup1tmp(1,nlocaltau1)=dvxx_p
                taup1tmp(2,nlocaltau1)=dvxy_p
                taup1tmp(3,nlocaltau1)=dvxz_p
                taup1tmp(4,nlocaltau1)=dvyx_p
                taup1tmp(5,nlocaltau1)=dvyy_p
                taup1tmp(6,nlocaltau1)=dvyz_p
                taup1tmp(7,nlocaltau1)=dvzx_p
                taup1tmp(8,nlocaltau1)=dvzy_p
                taup1tmp(9,nlocaltau1)=dvzz_p
...
c                ilocaltau1(2,nlocaltau1)=k
                ...
                !elsttau1_tmp(k,ia)=nlocaltau1
                elsttau1_tmp(3,kkk,iter3)=nlocaltau1
...
c                taulocal1p(9,nlocaltau1)= -duzz_p-dvzz_p
                ...
                taud1tmp(1,nlocaltau1)= -duxx_d-dvxx_d
                taud1tmp(2,nlocaltau1)= -duxy_d-dvxy_d
                taud1tmp(3,nlocaltau1)= -duxz_d-dvxz_d
                taud1tmp(4,nlocaltau1)= -duyx_d-dvyx_d
                taud1tmp(5,nlocaltau1)= -duyy_d-dvyy_d
                taud1tmp(6,nlocaltau1)= -duyz_d-dvyz_d
                taud1tmp(7,nlocaltau1)= -duzx_d-dvzx_d
                taud1tmp(8,nlocaltau1)= -duzy_d-dvzy_d
                taud1tmp(9,nlocaltau1)= -duzz_d-dvzz_d
                taup1tmp(1,nlocaltau1)= -duxx_p-dvxx_p
                taup1tmp(2,nlocaltau1)= -duxy_p-dvxy_p
                taup1tmp(3,nlocaltau1)= -duxz_p-dvxz_p
                taup1tmp(4,nlocaltau1)= -duyx_p-dvyx_p
                taup1tmp(5,nlocaltau1)= -duyy_p-dvyy_p
                taup1tmp(6,nlocaltau1)= -duyz_p-dvyz_p
                taup1tmp(7,nlocaltau1)= -duzx_p-dvzx_p
                taup1tmp(8,nlocaltau1)= -duzy_p-dvzy_p
                taup1tmp(9,nlocaltau1)= -duzz_p-dvzz_p
