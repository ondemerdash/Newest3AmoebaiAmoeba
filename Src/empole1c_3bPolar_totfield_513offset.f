      subroutine empole1c_3b_Polar_totfield_513offset(offset,embedlst,
     &   nembedlst,npole3b,pnum,eptemp,deptemp,virtemp)
      use bound
      use sizes
      use atoms
      use chgpot
...
c      integer, allocatable :: nembedlst(:)
      ...
      integer embedlst(maxelst,9)
      integer nembedlst(9),kk
      integer offset
      integer npole3b_mono,pnum_mono(9)
...
c   Zero out temporary gradient of polarization energy
      ...
      npole3b_mono=npole3b-offset

      do l1=offset+1,npole3b
         l3=l1-offset
         pnum_mono(l3)=pnum(l1)
      end do
     ...
     &!                 planf3b,planb3b,iprime3b,ffttable3b)   
       ...
       call induce0a_3b_totfield(npole3b_mono,pnum_mono,uind,uinp,
     &              qgrid3b,planf3b,planb3b,iprime3b,ffttable3b)
...
c     &   ffttable3b)
     ...
     & !  iprime3b,ffttable3b)
      ...
      call emrecip1_1and2_3b_Polar_totfield_parl_513(npole3b_mono,
     &   pnum_mono,uind,uinp,eptemp,deptemp,virtemp,qgrid3b,
     &   planf3b,planb3b,
     &   iprime3b,ffttable3b)
...
c       print*,"Before ereal1c2_3b_totfieldnpole3b"
     ...
     &  deptemp,virtemp)
       ...
       call ereal1c1_3b_totfieldnpole(npole3b_mono,
     &  pnum_mono,uind,uinp,deptemp2,virtemp)
       !call ereal1c2_3b_totfieldnpole(npole3b,
     & ! pnum,uind,uinp,eptemp,deptemp,virtemp)
        
       
       call ereal1d2_3b_totfieldnpole_511offset(offset,npole3b,
