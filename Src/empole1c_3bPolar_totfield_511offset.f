      subroutine empole1c_3b_Polar_totfield_511offset(offset,embedlst,
...
c      integer, allocatable :: nembedlst(:)
      ...
      integer nembedlst(9)
      integer offset
      integer npole3b_mono,pnum_mono(9),kk
...
c   Zero out temporary gradient of polarization energy
      ...
      !call induce0c_3b_new(npole3b,pnum,uind,uinp)
       call induce0a_3b(npole3b_mono,pnum_mono,uind,uinp,thetai1_3b,
...
c     &   ffttable3b)
     ...
     &!   ffttable3b)
      call emrecip1_1and2_3b_Polar_totfield_parl(npole3b_mono,pnum_mono,
