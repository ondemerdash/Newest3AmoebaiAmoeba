...
c
c
      subroutine emrecip1_1and2_3b_Polar_totfield_parl(npole3b,pnum,
...
c               cmp(j,i) = cmp(j,i) + uinp(j-1,i)
         ...
         !call cmp_to_fmp3b_totfield (npole3b,pnum,cmp,fmp)
...
c
         call grid_uind3b_totfield (npole3b,pnum,fuind,fuinp,qgrid3b,
