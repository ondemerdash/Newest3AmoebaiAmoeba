      ...
      subroutine ClustNoListSmoothInnerloop1_1b_Orig2NoOmplist 
...
c!$OMP& schedule(guided)
      ...
      do clust1=start,last
           ...
           npole3b=np1
           cnt=cnt+1
c          print*,"use_ewaldclust=",use_ewaldclust

c         if(use_ewaldclust) then
c          call empole1d_3b_Polar_orig_nopriordiromp1b(npole3b,pnum,
c     &         eptemp,deptemp,virtemp,cnt)
c         else
          call empole1b_3b_Polar_orig_nopriordiromp1b(npole3b,pnum,
