...
c              call gradient_emreal_bcast
            ...
            switchmode = 'MPOLE'
            call switch (switchmode)
            print*,"taskid,xcell xcell2",xcell,xcell2
            print*,"taskid,ycell ycell2",ycell,ycell2
            print*,"taskid,zcell zcell2",zcell,zcell2

c            if(taskid.eq.master) then
            call stotfieldsmallsmooth2_gradient_polar_load_balanced(
