      ...
      if(exist.eqv..false.) then
         if (integrate .eq. 'RIGIDBODY') then
            ...
            if(taskid.eq.master) then
              ...
              allocate (derivs(3,n))
              call prep_pole
c              call gradslow_serial(energy,derivs)
...
c            print*,"After all 2body list bcast"
            ...
            if(taskid.eq.master) then
c       THE FOLLOWING CALLS CORRESPOND TO GRADSLOW 
             call gradient_vdw
            ...
            call smooth2_gradient_polar(start,start+offset-1,moli1)
