      subroutine ufield0c_3b_vacompbox2bclust(npole3b,pnum,field,fieldp,
     &   uind,uinp,cnt)
      use sizes
      use atoms
      use boxes
...
c
      ...
      call umutual1_3b_newbox2bclust(npole3b,pnum,field,fieldp,
     &      uind,uinp,cnt)
c
...
c
c
      subroutine umutual1_3b_newbox2bclust(npole3b,pnum,field,fieldp,
     &           uind,uinp,cnt)
      use sizes
      use boxes
      use boxes2bclust
