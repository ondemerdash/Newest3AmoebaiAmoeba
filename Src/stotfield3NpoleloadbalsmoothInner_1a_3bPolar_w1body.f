      ...
      subroutine stotfield3NpoleLoadBalNew2SmoothInnerloop1_2cut_w1body 
...
c      print*,"12/17 Original Version!"
      print*,"3Totfieldversion taskid",taskid
...
c          moli2=mollst(k1,moli1)
          ...
          call empole1a_3b_Polar_totfieldnpole3(npole3b,
...
c            i = pnum(l1)
          ...
          if(len2.eq.3) then
            ...
            pnum(3)=imol(2,moli2)
          else if (len2.eq.5) then
            npole3b=5
            pnum(1)=imol(1,moli2)
            pnum(2)=imol(1,moli2)+1
            pnum(3)=imol(1,moli2)+2
            pnum(4)=imol(1,moli2)+3
            pnum(5)=imol(2,moli2)
          end if
          call empole1a_3b_Polar_totfieldnpole3(npole3b,
     &           pnum,eptemp,deptemp,virtemp)
...
c            print*,"moli1 moli2 ep2moli12",moli1,moli2,ep2moli12
          do moli3=moli2+1,nmol
               len3=imol(2,moli3)-imol(1,moli3)+1
              if((len1.eq.3).and.(len2.eq.3)
     &          .and.(len3.eq.3)) then
               npole3b=9
               pnum(1)=imol(1,moli1)
               pnum(2)=imol(1,moli1)+1
     ...
     &           .and.(len3.eq.3)) then
                ...
                pnum(8)=imol(2,moli2)
                pnum(9)=imol(1,moli3)
                pnum(10)=imol(1,moli3)+1
                pnum(11)=imol(2,moli3)
                np1=5
                np2=8
                np3=11
              end if
              if((len1.eq.3).and.(len2.eq.5)
     &           .and.(len3.eq.3)) then
                npole3b=11
                pnum(1)=imol(1,moli1)
                pnum(2)=imol(1,moli1)+1
     ...
     &           .and.(len3.eq.5)) then
                ...
                pnum(7)=imol(1,moli3)
                pnum(8)=imol(1,moli3)+1
                pnum(9)=imol(1,moli3)+2
                pnum(10)=imol(1,moli3)+3
                pnum(11)=imol(2,moli3)
                np1=3
                np2=6
                np3=11
                ...
                call empole1a_3b_Polar_totfieldnpole3(
...
c                  i = pnum(l1)
                ...
                do i=1,3
                  ...
                  if(len2.eq.3.and.len3.eq.3) then
                    npole3b=6
                    pnum(1)=imol(1,moli2)
                    pnum(2)=imol(1,moli2)+1
                    pnum(3)=imol(2,moli2)
                    ...
                    pnum(6)=imol(2,moli3)
                  else if((len2.eq.3).and.(len3.eq.5)) then
                    npole3b=8
                    pnum(1)=imol(1,moli2)
                    pnum(2)=imol(1,moli2)+1
                    pnum(3)=imol(2,moli2)
                    pnum(4)=imol(1,moli3)
                    pnum(5)=imol(1,moli3)+1
                    pnum(6)=imol(1,moli3)+2
                    pnum(7)=imol(1,moli3)+3
                    pnum(8)=imol(2,moli3)
                  else if((len2.eq.5).and.(len3.eq.3)) then
                    npole3b=8
                    pnum(1)=imol(1,moli2)
                    pnum(2)=imol(1,moli2)+1
                    pnum(3)=imol(1,moli2)+2
     ...
     &            npole3b,pnum,eptemp,deptemp,virtemp)
                ...
                do i=1,npole
                 ...
                 dep3bt(3,i) = dep3bt(3,i)-deptemp(3,i)
                  ...
                  if(len1.eq.3.and.len3.eq.3) then
                    npole3b=6
                    pnum(1)=imol(1,moli1)
                    pnum(2)=imol(1,moli1)+1
                    pnum(3)=imol(2,moli1)
                    ...
                    pnum(5)=imol(1,moli3)+1
                    pnum(6)=imol(2,moli3)
                  else if((len1.eq.3).and.(len3.eq.5)) then
                    npole3b=8
                    pnum(1)=imol(1,moli1)
                    pnum(2)=imol(1,moli1)+1
                    pnum(3)=imol(2,moli1)
                    ...
                    pnum(7)=imol(1,moli3)+3
                    pnum(8)=imol(2,moli3)
                  else if((len1.eq.5).and.(len3.eq.3)) then
                    npole3b=8
                    pnum(1)=imol(1,moli1)
                    pnum(2)=imol(1,moli1)+1
                    pnum(3)=imol(1,moli1)+2
     ...
     &            npole3b,pnum,eptemp,deptemp,virtemp)
               ...
               if(len3.eq.3) then
                ...
                pnum(3)=imol(2,moli3)
               else if (len3.eq.5) then
                npole3b=5
                pnum(1)=imol(1,moli3)
                pnum(2)=imol(1,moli3)+1
                pnum(3)=imol(1,moli3)+2
                pnum(4)=imol(1,moli3)+3
                pnum(5)=imol(2,moli3)
               end if
                 call empole1a_3b_Polar_totfieldnpole3(
     &           npole3b,pnum,eptemp,deptemp,virtemp)
