      ...
      subroutine EwClustNoListSmoothInnerloop1_2cut_wskinOrig 
...
c!$OMP& schedule(guided)
      do clust1=start,last
           ...
           npole3b=np1
          call empole1c_3b_Polar(npole3b,pnum,ep1moli1,
     &         dep1moli1,vir1moli1)
...
c           clust2=mollst(k1,clust1)
        do clust2=clust1+1,clustcount
          ...
          npole3b=np1+np2
          call empole1c_3b_Polar(npole3b,pnum,
     &         ep2moli12,dep2moli12,vir2moli12)
          ...
          call empole1c_3b_Polar(npole3b,pnum,ep1moli2,
     &         dep1moli2,vir1moli2)
...
c              shellsum=r1+r3
c              if (shellsum.le.Cobarcut3b) then
c                call empole1c_3b_Polar(npole3b,pnum,
