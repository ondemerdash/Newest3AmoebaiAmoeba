c
c
      subroutine empole1b_3b_Polar_orig_nopriordiromp1b(npole3b,pnum,
...
!$OMP& private(i,j,k,ii,ix,iy,iz,usei,kk,kx,ky,kz,usek,proceed,ei,
...
!$OMP& ci,dix,diy,diz,qixx,qixy,qixz,qiyx,qiyy,qiyz,qizx,qizy,qizz,
!$OMP& ck,dkx,dky,dkz,qkxx,qkxy,qkxz,qkyx,qkyy,qkyz,qkzx,qkzy,qkzz,
!$OMP& fridmp,findmp,ftm2,ftm2i,ttm2,ttm3,ttm2i,ttm3i,
!$OMP& fdir,dkxui,dixuk,dixukp,dkxuip,uixqkr,ukxqir,uixqkrp,
!$OMP& ukxqirp,qiuk,qkui,qiukp,qkuip,rxqiuk,rxqkui,rxqiukp,rxqkuip,
!$OMP& qidk,qkdi,qirx,qiry,qirz,qkrx,qkry,qkrz,qiqkr,qkqir,rxqir,dixr,
!$OMP& dkxr,dixqkr,
!$OMP& dkxqir,rxqkr,qkrxqir,rxqikr,rxqkir,rxqidk,rxqkdi,
!$OMP& ddsc3,ddsc5,ddsc7,sc,sci,scip,gli,glip,gf,gfi,l1,l3,kkk,gti)
...
c
c      print*,"Done w empole1b_3b_Polar_orig_nopriordiromp1b"
c
