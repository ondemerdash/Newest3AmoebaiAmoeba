...
c     &  start,last,ep3bt,virep3bt,dep3bt,moli1rmndr)
      subroutine totfieldNpoleloadbalsmoothInner_1c_3bPolar2_513(
...
c!$OMP& schedule(guided)
      ...
      do moli1=start_polar(taskid),last_polar(taskid)
          ...
          do l1 = 1, npole3b
             ...
             do k = 1,npole
               ...
               r2at = xr*xr + yr*yr + zr*zr
               if ((r2at .le. ewaldcut2).and.(i.ne.k)) then
     ...
     &               -vir1moli1(j,i)-vir1moli2(j,i))
          ...
          do k2=1,nmollst(moli2)
            ...
            yr2 = y1 - y3
            zr2 = z1 - z3
            call imagen(xr2,yr2,zr2)
            xr3=x2-x3
            yr3=y2-y3
            zr3=z2-z3
            call imagen(xr3,yr3,zr3)
            ...
            if ((r1.lt.r3).and.(r2.lt.r3) ) then
              ...
              if (shellsum.le.Cobarcut3b) then            
               ...
               call empole1c_3b_Polar_totfield_513(embedlst,nembedlst,
     &             npole3b,pnum,ep3moli123,dep3moli123,vir3moli123)
     ...
     &           nembedlst,npole3b,pnum,eptemp,deptemp,virtemp)
               ...
               !     nembedlst(l1)=0
               !     do k=1,nembedlst(l2)
               !        embedlst(k,l1)=embedlst(k,l2)
               !     end do
               !     nembedlst(l1)=nembedlst(l2)
               !  end do
