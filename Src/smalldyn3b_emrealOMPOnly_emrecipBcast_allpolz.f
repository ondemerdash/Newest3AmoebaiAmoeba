...
c      print*,"Before bcast mechanic and ewald"
      ...
      print*,"After bcast mechanic and ewald"
...
c            listsend_mpole=.false.
     ...
     &       mpi_comm_world,ierr)
            ...
            call mpi_bcast(em,1,mpi_real8,master2,
     &       mpi_comm_world,ierr)
           call mpi_bcast(dem,3*n,mpi_real8,master2,
     &       mpi_comm_world,ierr)
           call mpi_bcast(viremreal_tmp,3*3,mpi_real8,master2,
     &       mpi_comm_world,ierr)
           end if
     ...
     &                   + dev(j,i) + dem(j,i)+dep3b(j,i)
               ...
               if (use(i)) then
                do j = 1, 3
                 ...
                 print*,"istep i j v(j,i)",istep,i,j,v(j,i)
                end do
               end if
              end do
