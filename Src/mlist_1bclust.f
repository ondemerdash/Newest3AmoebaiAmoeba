...
c
c
      subroutine mlist_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use boxes
...
c
      ...
      if (domlstclust1b(counter)) then
         ...
         if (octahedron) then
            call mbuild_1bclust(npole3b,pnum,counter)
         else
            call mlight_1bclust(npole3b,pnum,counter)
         end if
         return
      end if
c
...
c
c
      subroutine mbuild_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use iounit
...
c
c
      subroutine mlight_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use cell
