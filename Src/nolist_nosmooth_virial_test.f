...
c
      ...
      integer offset,remainder,start,moli1
...
c         print*,"After 1st mpi_bcast"
     ...
     &   mpi_comm_world,ierr)
            ...
            call gradient_polar(start,start+offset-1,moli1)
            if(taskid.eq.master) then
              do i=1,3
               do j=1,3
...
c            call gradient_setup
            call allocPermElec1
c            print*,"After mpi_buffer_attach"
...
c              call verlet_pt2(istep,dt,energy)
     ...
     &          +virep3b_analytic(3,3))/ (3.0d0*volbox)
                print*,"virep3b_analytic(1,1)",virep3b_analytic(1,1)
                print*,"virep3b_analytic(2,2)",virep3b_analytic(2,2)
                print*,"virep3b_analytic(3,3)",virep3b_analytic(3,3)
