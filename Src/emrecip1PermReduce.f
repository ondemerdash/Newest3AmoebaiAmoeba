c
      subroutine emrecip1_3b_Perm2_reduce(emrecipt,demrecipt,
     &   viremrecipt)
      use sizes
      use atoms
      use bound
...
c
      ...
      do i = 1, npole
        ...
        ! Condensed from below
         ii = ipole(i)
         demrecipt(1,ii) = demrecipt(1,ii) + frc(1,i)
         demrecipt(2,ii) = demrecipt(2,ii) + frc(2,i)
         demrecipt(3,ii) = demrecipt(3,ii) + frc(3,i)
...
c      end do
      ...
      do i = 1, n
         demrecipt(1,i) = demrecipt(1,i) + frc(1,i)
         demrecipt(2,i) = demrecipt(2,i) + frc(2,i)
         demrecipt(3,i) = demrecipt(3,i) + frc(3,i)
      end do
c
...
c
      viremrecipt(1,1) = viremrecipt(1,1) + vxx
      viremrecipt(2,1) = viremrecipt(2,1) + vyx
      viremrecipt(3,1) = viremrecipt(3,1) + vzx
      viremrecipt(1,2) = viremrecipt(1,2) + vyx
      viremrecipt(2,2) = viremrecipt(2,2) + vyy
      viremrecipt(3,2) = viremrecipt(3,2) + vzy
      viremrecipt(1,3) = viremrecipt(1,3) + vzx
      viremrecipt(2,3) = viremrecipt(2,3) + vzy
      viremrecipt(3,3) = viremrecipt(3,3) + vzz
c
c     perform deallocation of some local arrays
c
