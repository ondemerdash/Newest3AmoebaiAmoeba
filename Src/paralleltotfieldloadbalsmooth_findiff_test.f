...
c
c
      program paralleltotfieldloadbalsmooth_findiff_test
      use sizes
      use atoms
      use bath
      use bndstr
...
c            call mpi_waitall(6,reqs,stats2,ierr)
              ...
              if(taskid.eq.master) then
               ...
               if(uzepmedirpolz) then
              !   print*,"dep3b_recip in master=",dep3b_recip
     ...
     &          +virep3b1(j,i)
                 ...
                 do i=1,3
                    do j=1,3
            print*,"j i virep3b_recip_pt1",j,i,virep3b_recip_pt1(j,i)  
            print*,"j i virep3b_recip",j,i,virep3b_recip(j,i)
                    end do
                 end do
...
c               call verlet_pt2(istep,dt,energy)
              if(istep.eq.3) then
                print*,"Finite Diff PairwiseEng, PairwiseGradz",
     & (efindif(3)-efindif(1))/2.0d0/delx,analyticgy(2)
