     ...
     & start,last,moli1rmndr)
      ...
      ntript=0
         ...
         call  totfield3Npole1body_w1body(
     ...
     & start,last,moli1rmndr)
      ...
      ntript=0
         ...
         call  totfieldNpole1body_w1body(
     &   start,last,ep3bt,virep3bt,dep3bt,moli1rmndr) 
     ...
     &   !       mpi_sum,master,mpi_comm_world,ierr)
       ...
       print*,"totfield1bNpole Aftr mpi_reduce",taskid,ep3bt
     ...
     & start,last,moli1rmndr)
      ...
      ntript=0
         ...
         call  totfield1body_w1body_rtrndeptemp2(
     &   start,last,ep3bt,virep3bt,dep3bt,moli1rmndr)
