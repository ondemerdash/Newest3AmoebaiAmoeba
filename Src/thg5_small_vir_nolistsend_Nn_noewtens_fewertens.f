...
c     &  ntpair_dEtmp,dEindextmp,dEd1tmp,dEd2tmp,dEp1tmp,dEp2tmp)
      subroutine thg5_small_vir_nolistsend_Nn_noewtens2
...
c      real*8 demrealt(3,npole),viremrealt(3,3),emrealt
      real*8 fieldnpolet(3,npole),fieldpnpolet(3,npole)
      logical dorl,dorli
      character*6 mode
      real*8 bcn(3)
...
c      toffset0tau2 = 0
      ...
      do i=start_emreal2(taskid_offset),last_emreal2(taskid_offset)
         ...
         do kkk=1,nelst2(i)
              dEd1_3tmp(1,kkk,iter3)=0.0d0
              dEd2_3tmp(1,kkk,iter3)=0.0d0
              dEp1_3tmp(1,kkk,iter3)=0.0d0
              dEp2_3tmp(1,kkk,iter3)=0.0d0
            do j1=1,4
...
c      maxlocaltau=3*maxlocal
      ...
      print*,"taskid,taskoffset",taskid,taskid_offset,
     & "start_emreal2(taskid_offset)", start_emreal2(taskid_offset)
      print*,"taskid,taskoffset",taskid,taskid_offset,
     & "last_emreal2(taskid_offset)", last_emreal2(taskid_offset)
...
!$OMP& dEd1_3tmp,dEd2_3tmp,dEp1_3tmp,dEp2_3tmp,
!$OMP& n,x,y,z,rpole,ipole,pdamp,thole,n12,i12,
!$OMP& p2scale,n13,p3scale,i13,n14,i14,p4scale,
!$OMP& np11,ip11,p41scale,n15,p5scale,i15,
!$OMP& np12,ip12,d1scale,d2scale,np13,ip13,d3scale,np14,ip14,d4scale,
!$OMP& nelst2,elst2,xaxis,yaxis,zaxis,f,aewald,
!$OMP& use,use_intra,start_emreal2,last_emreal2,taskid_offset)
...
c!$OMP CRITICAL
             ...
             dEd1_3tmp(1,kkk,iter3)=t1xxd
             dEd1_3tmp(2,kkk,iter3)=t1xyd
             dEd1_3tmp(3,kkk,iter3)=t1xzd
             dEd1_3tmp(4,kkk,iter3)=t1yxd
             dEd1_3tmp(5,kkk,iter3)=t1yyd
             dEd1_3tmp(6,kkk,iter3)=t1yzd
             dEd1_3tmp(7,kkk,iter3)=t1zxd
             dEd1_3tmp(8,kkk,iter3)=t1zyd
             dEd1_3tmp(9,kkk,iter3)=t1zzd

             dEd2_3tmp(1,kkk,iter3)=t2xxd
             dEd2_3tmp(2,kkk,iter3)=t2xyd
             dEd2_3tmp(3,kkk,iter3)=t2xzd
             dEd2_3tmp(4,kkk,iter3)=t2yxd
             dEd2_3tmp(5,kkk,iter3)=t2yyd
             dEd2_3tmp(6,kkk,iter3)=t2yzd
             dEd2_3tmp(7,kkk,iter3)=t2zxd
             dEd2_3tmp(8,kkk,iter3)=t2zyd
             dEd2_3tmp(9,kkk,iter3)=t2zzd

             dEp1_3tmp(1,kkk,iter3)=t1xxp
             dEp1_3tmp(2,kkk,iter3)=t1xyp
             dEp1_3tmp(3,kkk,iter3)=t1xzp
             dEp1_3tmp(4,kkk,iter3)=t1yxp
             dEp1_3tmp(5,kkk,iter3)=t1yyp
             dEp1_3tmp(6,kkk,iter3)=t1yzp
             dEp1_3tmp(7,kkk,iter3)=t1zxp
             dEp1_3tmp(8,kkk,iter3)=t1zyp
             dEp1_3tmp(9,kkk,iter3)=t1zzp

             dEp2_3tmp(1,kkk,iter3)=t2xxp
             dEp2_3tmp(2,kkk,iter3)=t2xyp
             dEp2_3tmp(3,kkk,iter3)=t2xzp
             dEp2_3tmp(4,kkk,iter3)=t2yxp
             dEp2_3tmp(5,kkk,iter3)=t2yyp
             dEp2_3tmp(6,kkk,iter3)=t2yzp
             dEp2_3tmp(7,kkk,iter3)=t2zxp
             dEp2_3tmp(8,kkk,iter3)=t2zyp
             dEp2_3tmp(9,kkk,iter3)=t2zzp
...
c     &  nlocal,
c     &  k,kkk)
           call torque3_dEtensor_72015_taunew3_pt1_vir2(i,
     &  ttm2i,tau1d,tau1p,
     &  k,kkk,iter3)
...
c     &  k,kkk)
           ...
           call torque3_dEtensor_72015_taunew3_pt2_vir2(i,
     &  ttm3i,tau2d,tau2p,
     &  k,kkk,iter3)
...
c      print*,"End of MPI TensorLoad Bal Innerloop EMreal"
      print*,"Completed thg5_small_vir_nolistsend_Nn_noewtens_fewertens"
c
