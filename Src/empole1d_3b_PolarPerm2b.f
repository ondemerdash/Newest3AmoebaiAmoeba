      subroutine empole1d_3b_PolarPerm2b(npole3b,pnum,
...
c      end if
     ...
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      ...
      call ereal1d_3b_2bclustPolarPerm(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
...
c        if(i.eq.0) then
c       print*,"Tilt!empole1d_PolarPerm2b b4 SelfTorq",taskid,cnt,npole3b
c        else 
c       print*,"In empole1d_PolarPerm2b b4 SelfTorque",taskid,cnt,npole3b
c        end if
...
c
c
      subroutine ereal1d_3b_2bclustPolarPerm(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      use sizes
      use atoms
      use bound
