      ...
      subroutine uindClustEmpole1plz_3b_NoOmplistRtrn3BNoSubtr1b2bsimult
...
c      real*8  dep2moli12(3,36)
      ...
      integer cnt,taskid_offset
      real*8 r
      real*8 uind3bt(3,npole)
...
c        allocate(dem2moli12(3,npole))

        allocate(pnum(3*3*maxsizeclust))
        taskid_offset=taskid-numtasks_polar1-numtasks_polar

        !print*,"Begin ClustEmpole1plz_3b_NoOmp",taskid,taskid_offset 
...
c          cnt=cnt+1
     ...
     &    !     ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
            !else
c          call empole1d_3b_PolarPerm3btest(npole3b,pnum,
c     &         ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
          call uindempole1d_3b_Polar3btest2(npole3b,pnum,
     &         ep2moli12,dep2moli12,vir2moli12,cnt,uind)!,em2moli12,dem2moli12)
...
c                  dem3bt(j,i) = dem3bt(j,i)+dem2moli12(j,l1)
                  ...
                  uind3bt(j,i) = uind3bt(j,i)+uind(j,l1)
c                  dem3bt(j,i) = dem3bt(j,i)+dem2moli12(j,i)
...
c!$OMP END DO
c!$OMP END PARALLEL
      !print*,"End ClustEmpole1plz_3b_NoOmp",taskid,taskid_offset,ep3bt
        deallocate(dep2moli12)
c        deallocate(deptemp)
        deallocate(pnum)
c        deallocate(dem2moli12)
