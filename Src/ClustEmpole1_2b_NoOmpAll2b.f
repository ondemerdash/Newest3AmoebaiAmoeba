      ...
      subroutine ClustEmpole1_2b_NoOmpAll2b
...
c     &                         last_mollst_polar(k3,clust1,taskid)
...
c          if(r1_2.le.Rcut2b2) then
          ...
          npole3b=np1+np2
c          call empole1d_3b_PolarPerm2b(npole3b,pnum,
c     &         ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
     ...
     &         ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
          ...
          do l1 = 1, np1
             i = pnum(l1)
             do j = 1, 3
c              dep2moli12(j,l1)= dep2moli12(j,l1)-dep1bmat(j,l1,clust1)
c              dem2moli12(j,l1)=dem2moli12(j,l1)-dem1bmat(j,l1,clust1)
              dep2moli12(j,i)= dep2moli12(j,i)-dep1bmat(j,l1,clust1)
              dem2moli12(j,i)=dem2moli12(j,i)-dem1bmat(j,l1,clust1)
             end do
          end do
          do i=1,3
            do j=1,3
          ...
          do l1 =1, npole3b
             ...
             i=pnum(l2)
             do j=1,3
c              dep2moli12(j,l2) = dep2moli12(j,l2)-dep1bmat(j,l1,clust2)
c              dem2moli12(j,l2) = dem2moli12(j,l2)-dem1bmat(j,l1,clust2)
              dep2moli12(j,i) = dep2moli12(j,i)-dep1bmat(j,l1,clust2)
              dem2moli12(j,i) = dem2moli12(j,i)-dem1bmat(j,l1,clust2)
             end do
          end do
          do i=1,3
            do j=1,3
