      ...
      subroutine totfieldLoadBalNew2SmoothInnerloop1_rtrndeptemp2fij
...
c      real*8 eptemp,deptemp(3,30)
      ...
      real*8 depmat1moli1(3,npole,npole),depmat1moli2(3,npole,npole)
...
c      print*,"12/17 Original Version!"
      print*,"EmbedI Totfieldversion taskid",taskid
...
!$OMP& Rcut2b2,nmol,npole,start,last,depmat3bt)
...
c          moli2=mollst(k1,moli1)
          ...
          pnum(3)=imol(2,moli1)
          npole3b=3
         call empole1a_3b_Polar_totfieldnpole3b_rtrndeptemp2fij(npole3b,
...
c            r1=sqrt(r1_2)
            ...
            if((r1.lt.r3).and.(r2.lt.r3) ) then
              ...
              shellsum=r2+r3
                ...
                call empole1a_3b_Polar_totfieldnpole3b_rtrndeptemp2fij(
