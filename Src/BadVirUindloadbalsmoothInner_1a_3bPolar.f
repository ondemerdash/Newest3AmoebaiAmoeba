...
c            do l1 = 1,npole3b
c              i = pnum(l1)
c              dep2moli12(1,l1)=dep2moli12(1,l1)*tapr2b
c     &                       + ep2moli12*dtapr2b_x(l1)
c              dep2moli12(2,l1)=dep2moli12(2,l1)*tapr2b
c     &                       + ep2moli12*dtapr2b_y(l1)
c              dep2moli12(3,l1)=dep2moli12(3,l1)*tapr2b
...
c            do i=1,3
c              do j=1,3
c                vir2moli12(j,i)=vir2moli12(j,i)*tapr2b
c              end do
c            end do
c            do l1=1,np1
c               i=pnum(l1)
c               if(name(i).eq.'O') then
c              vir2moli12(1,1)=vir2moli12(1,1)
c     &                          +dtapr2b_x(l1)*ep2moli12*x1
c              vir2moli12(2,1)=vir2moli12(2,1)
c     &                          +dtapr2b_x(l1)*ep2moli12*y1
c              vir2moli12(3,1)=vir2moli12(3,1)
c     &                           +dtapr2b_x(l1)*ep2moli12*z1
c              vir2moli12(1,2)=vir2moli12(1,2)
c     &                           +dtapr2b_y(l1)*ep2moli12*x1
c              vir2moli12(2,2)=vir2moli12(2,2)
c     &                           +dtapr2b_y(l1)*ep2moli12*y1
c              vir2moli12(3,2)=vir2moli12(3,2)
c     &                           +dtapr2b_y(l1)*ep2moli12*z1
c              vir2moli12(1,3)=vir2moli12(1,3)
c     &                           +dtapr2b_z(l1)*ep2moli12*x1
c              vir2moli12(2,3)=vir2moli12(2,3)
c     &                           +dtapr2b_z(l1)*ep2moli12*y1
c              vir2moli12(3,3)=vir2moli12(3,3)
...
c            end do
     ...
     &                          +dtapr2b_x(l1)*ep2moli12*x1
              virep3bt(2,1)=virep3bt(2,1)
     &                          +dtapr2b_x(l1)*ep2moli12*y1
              virep3bt(3,1)=virep3bt(3,1)
     &                           +dtapr2b_x(l1)*ep2moli12*z1
              virep3bt(1,2)=virep3bt(1,2)
     &                           +dtapr2b_y(l1)*ep2moli12*x1
              virep3bt(2,2)=virep3bt(2,2)
     &                           +dtapr2b_y(l1)*ep2moli12*y1
              virep3bt(3,2)=virep3bt(3,2)
     &                           +dtapr2b_y(l1)*ep2moli12*z1
              virep3bt(1,3)=virep3bt(1,3)
     &                           +dtapr2b_z(l1)*ep2moli12*x1
              virep3bt(2,3)=virep3bt(2,3)
     &                           +dtapr2b_z(l1)*ep2moli12*y1
              virep3bt(3,3)=virep3bt(3,3)
     &                           +dtapr2b_z(l1)*ep2moli12*z1
               end if
            end do
            do l1=np1+1,npole3b
               i=pnum(l1)
               if(name(i).eq.'O') then
              virep3bt(1,1)=virep3bt(1,1)
     &                          +dtapr2b_x(l1)*ep2moli12*x2min
              virep3bt(2,1)=virep3bt(2,1)
     &                          +dtapr2b_x(l1)*ep2moli12*y2min
              virep3bt(3,1)=virep3bt(3,1)
     &                           +dtapr2b_x(l1)*ep2moli12*z2min
              virep3bt(1,2)=virep3bt(1,2)
     &                           +dtapr2b_y(l1)*ep2moli12*x2min
              virep3bt(2,2)=virep3bt(2,2)
     &                           +dtapr2b_y(l1)*ep2moli12*y2min
              virep3bt(3,2)=virep3bt(3,2)
     &                           +dtapr2b_y(l1)*ep2moli12*z2min
              virep3bt(1,3)=virep3bt(1,3)
     &                           +dtapr2b_z(l1)*ep2moli12*x2min
              virep3bt(2,3)=virep3bt(2,3)
     &                           +dtapr2b_z(l1)*ep2moli12*y2min
              virep3bt(3,3)=virep3bt(3,3)
     &                           +dtapr2b_z(l1)*ep2moli12*z2min
               end if
            end do
...
c     &                 +dtapr3b_iz*ep3moli123*z(i)
     ...
     &                 +dtapr3b_iz*ep3moli123*z1
                  ...
                  do l1=np1+1,np2
                    ...
                    if(name(i).eq.'O') then
c                    vir3moli123(1,1)=vir3moli123(1,1)
c     &                   +dtapr3b_jx*ep3moli123*x(i)
c                    vir3moli123(2,1)=vir3moli123(2,1)
c     &                   +dtapr3b_jx*ep3moli123*y(i)
c                    vir3moli123(3,1)=vir3moli123(3,1)
c     &                   +dtapr3b_jx*ep3moli123*z(i)
c                    vir3moli123(1,2)=vir3moli123(1,2)
c     &                   +dtapr3b_jy*ep3moli123*x(i)
c                    vir3moli123(2,2)=vir3moli123(2,2)
c     &                   +dtapr3b_jy*ep3moli123*y(i)
c                    vir3moli123(3,2)=vir3moli123(3,2)
c     &                   +dtapr3b_jy*ep3moli123*z(i)
c                    vir3moli123(1,3)=vir3moli123(1,3)
c     &                   +dtapr3b_jz*ep3moli123*x(i)
c                    vir3moli123(2,3)=vir3moli123(2,3)
c     &                   +dtapr3b_jz*ep3moli123*y(i)
c                    vir3moli123(3,3)=vir3moli123(3,3)
c     &                   +dtapr3b_jz*ep3moli123*z(i)

                    vir3moli123(1,1)=vir3moli123(1,1)
     &                   +dtapr3b_jx*ep3moli123*x2min
                    vir3moli123(2,1)=vir3moli123(2,1)
     &                   +dtapr3b_jx*ep3moli123*y2min
                    vir3moli123(3,1)=vir3moli123(3,1)
     &                   +dtapr3b_jx*ep3moli123*z2min
                    vir3moli123(1,2)=vir3moli123(1,2)
     &                   +dtapr3b_jy*ep3moli123*x2min
                    vir3moli123(2,2)=vir3moli123(2,2)
     &                   +dtapr3b_jy*ep3moli123*y2min
                    vir3moli123(3,2)=vir3moli123(3,2)
     &                   +dtapr3b_jy*ep3moli123*z2min
                    vir3moli123(1,3)=vir3moli123(1,3)
     &                   +dtapr3b_jz*ep3moli123*x2min
                    vir3moli123(2,3)=vir3moli123(2,3)
     &                   +dtapr3b_jz*ep3moli123*y2min
                    vir3moli123(3,3)=vir3moli123(3,3)
     &                   +dtapr3b_jz*ep3moli123*z2min
                    end if
                  end do
                  do l1=np2+1,npole3b
                     i = pnum(l1)
                    if(name(i).eq.'O') then
c                    vir3moli123(1,1)=vir3moli123(1,1)
c     &                  +dtapr3b_kx*ep3moli123*x(i)
c                    vir3moli123(2,1)=vir3moli123(2,1)
c     &                  +dtapr3b_kx*ep3moli123*y(i)
c                    vir3moli123(3,1)=vir3moli123(3,1)
c     &                  +dtapr3b_kx*ep3moli123*z(i)
c                    vir3moli123(1,2)=vir3moli123(1,2)
c     &                  +dtapr3b_ky*ep3moli123*x(i)
c                    vir3moli123(2,2)=vir3moli123(2,2)
c     &                  +dtapr3b_ky*ep3moli123*y(i)
c                    vir3moli123(3,2)=vir3moli123(3,2)
c     &                  +dtapr3b_ky*ep3moli123*z(i)
c                    vir3moli123(1,3)=vir3moli123(1,3)
c     &                  +dtapr3b_kz*ep3moli123*x(i)
c                    vir3moli123(2,3)=vir3moli123(2,3)
c     &                  +dtapr3b_kz*ep3moli123*y(i)
c                    vir3moli123(3,3)=vir3moli123(3,3)
c     &                  +dtapr3b_kz*ep3moli123*z(i)

                    vir3moli123(1,1)=vir3moli123(1,1)
     &                  +dtapr3b_kx*ep3moli123*x3min
                    vir3moli123(2,1)=vir3moli123(2,1)
     &                  +dtapr3b_kx*ep3moli123*y3min
                    vir3moli123(3,1)=vir3moli123(3,1)
     &                  +dtapr3b_kx*ep3moli123*z3min
                    vir3moli123(1,2)=vir3moli123(1,2)
     &                  +dtapr3b_ky*ep3moli123*x3min
                    vir3moli123(2,2)=vir3moli123(2,2)
     &                  +dtapr3b_ky*ep3moli123*y3min
                    vir3moli123(3,2)=vir3moli123(3,2)
     &                  +dtapr3b_ky*ep3moli123*z3min
                    vir3moli123(1,3)=vir3moli123(1,3)
     &                  +dtapr3b_kz*ep3moli123*x3min
                    vir3moli123(2,3)=vir3moli123(2,3)
     &                  +dtapr3b_kz*ep3moli123*y3min
                    vir3moli123(3,3)=vir3moli123(3,3)
     &                  +dtapr3b_kz*ep3moli123*z3min
                    end if
                  end do
                  do i=1,3
                    do j=1,3
