c     #############################################################
c     ##                                                         ##
c     ##  subroutine grid_mpole3b_new  --  put multipoles on PME grid  ##
c     ##                                                         ##
c     #############################################################
c
c
...
c
c
      subroutine grid_mpole3b_new (npole3b,pnum,fmp)
      use sizes
      use atoms
      use chunks
      use mpole
...
c     #################################################################
c     ##                                                             ##
c     ##  subroutine grid_uind3b_new  --  put induced dipoles on PME grid  ##
c     ##                                                             ##
c     #################################################################
c
c
...
c
c
      subroutine grid_uind3b_new (npole3b,pnum,fuind,fuinp)
      use sizes
      use atoms
      use chunks
      use mpole
...
c     ################################################################
c     ##                                                            ##
c     ## subroutine fphi_mpole3b_new  -multipole potential from grid  ##
c     ##                                                            ##
c     ################################################################
c
c
...
c
c
      subroutine fphi_mpole3b_new (npole3b,pnum,fphi)
      use sizes
      use mpole
      use pme
      implicit none
...
c     #############################################################
c     ##                                                         ##
c     ##  subroutine fphi_uind3b_new  --induced potential from grid 
c     ##                                                         ##
c     #############################################################
c
c
...
c
c
      subroutine fphi_uind3b_new (npole3b,pnum,
...
!$OMP& thetai1,qgrid,fdip_phi1,fdip_phi2,fdip_sum_phi,npole3b,pnum)
!$OMP DO
c
