      subroutine clust_gradient_Polar1b2b3bsimultreducematcommsmall2
     & (start,
     & last,moli1rmndr)
      use mpole
      use mpidat
...
c            t3=mpi_Wtime()
     ...
     &      mpi_real8,mpi_sum,master,emreal_comm,ierr)
c
...
c     &          mpi_sum,master,emreal_comm2,ierr)
     ...
     &            mpi_real8,mpi_sum,master,emreal_comm2,ierr)
...
c          do i=1,3
c            do j=1,3
c              virep3b(j,i)=virep3b(j,i)-virep2bmatmod(j,i,ind)
c            end do
c          end do 
...
c          do i=1,3
c             do j=1,3
c                virep3b(j,i)=virep3b(j,i)+virep1bmat(j,i,clust3)
c             end do
c          end do
