c
c
      subroutine empole1a_3b_Polar_totfieldnpole3(npole3b,pnum,eptemp,
     &   deptemp,virtemp)
      use bound
      use sizes
      use atoms
...
c      call induce0a_3b_PolelecOnly_totfieldnpole(npole3b,pnum,uind,
c     &     uinp)
c
c      call empole1a1_3b_Polar_totfieldnpole_mod(npole3b,pnum,uind,
c     &     uinp,deptemp2,virtemp)
c
c      call empole1a2_3b_Polar_totfieldnpole_mod(npole3b,pnum,uind,uinp,
c     &     eptemp,deptemp,virtemp)

      call induce0a_3b_PolelecOnly_totfieldnpole3(npole3b,pnum,uind,
     &     uinp)

      call empole1a1_3b_Polar_totfieldnpole_mod3(npole3b,pnum,uind,
     &     uinp,deptemp2,virtemp)

      call empole1a2_3b_Polar_totfieldnpole_mod3(npole3b,pnum,uind,uinp,
     &     eptemp,deptemp,virtemp)
      
c      call empole1a_mod(npole3b,pnum,uind,uinp,eptemp,
c     &   deptemp,virtemp)
