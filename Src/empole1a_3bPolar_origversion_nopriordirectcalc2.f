c
c
      subroutine empole1a_3b_Polar_orig_nopriordir(npole3b,pnum,eptemp,
     &   deptemp,virtemp)
      use bound
      use sizes
      use atoms
...
c
     ...
     & uind,uinp) 
       ...
       call induce0a_3b_scf_vac(npole3b,pnum,uind,uinp)
      else
...
c      print*,"eptemp",eptemp
      ...
      subroutine induce0a_3b_PolelecOnly_orig_nopriordir(npole3b,pnum,
     & uind,uinp)
      use sizes
      use atoms
      use polar, only: polarity, thole, pdamp
