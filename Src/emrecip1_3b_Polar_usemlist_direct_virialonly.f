...
c
c
      subroutine emrecip1_3b_Polar_usemlist_direct_virialonly
      use sizes
      use atoms
      use bound
      use boxes
...
c
      ...
      print*,"After bsplin emrecip1_3b_Polar_usemlist_direct_virialonly"

      call table_fill_omp
c      call table_fill
      print*,"After table emrecip1_3b_Polar_usemlist_direct_virialonly"
c
c     perform dynamic allocation of some local arrays
c
      allocate (qgrip(2,nfft1,nfft2,nfft3))
      print*,"use_polar=",use_polar
c      print*,"uind in emrecip1_3b_Polar_direct_virialonly",uind
      if (use_polar) then
         do i = 1, npole
            do j = 2, 4
