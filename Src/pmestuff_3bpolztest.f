...
c
c
      subroutine grid_mpole3b (npole3b,pnum,fmp)
      use sizes
      use atoms
      use chunks
      use mpole
...
c
c
      subroutine grid_uind3b (npole3b,pnum,fuind,fuinp)
      use sizes
      use atoms
      use chunks
      use mpole
...
c
c
      subroutine fphi_mpole3b (npole3b,pnum,fphi)
      use sizes
      use mpole
      use pme
      implicit none
...
c
c
      subroutine fphi_uind3b (npole3b,pnum,
