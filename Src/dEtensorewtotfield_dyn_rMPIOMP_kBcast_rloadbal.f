...
c
c
      program dEtensorewtotfield_dyn_rMPIOMP_kBcast_rloadbal 
      use sizes
      use atoms
      use bath
      use bndstr
      ...
      integer mpi_comm_world_size,orig_group,taskidem(4),new_group
...
c            end if
     ...
     &                       + viremrecip(j,i)
                ...
                energy = eb + ea + eba + eub + eopb + et + ept  + ett
     &                   + ev + em+ep3b
c              efindif(istep)=energy
c              efindif_ep3b(istep)=ep3b
