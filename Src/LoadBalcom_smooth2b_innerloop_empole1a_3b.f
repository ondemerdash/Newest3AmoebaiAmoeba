c
      subroutine LoadBalCOMSmooth2bInnerloop1_2cut_wskin( 
...
c      print*,"Begin 2body Load-Balanced New Taper"

!$OMP PARALLEL default(private) shared(imol,ep3bt,Rcut2b_input,
!$OMP& SwitchR2b,virep3bt,dep3bt,start_polar,last_polar,molnew,
!$OMP& nmollst,mollst,mass,x,y,z,rtapr2b_input,taskid)
...
c      print*,"2BodyLoadBalInnerloop= ep3bt=",ep3bt
