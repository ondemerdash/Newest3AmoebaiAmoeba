...
c
      ...
      mode = 'MPOLE'
      call switch (mode)
      print*,"Beginning of empole1a_Perm off2",off2
      print*,"Empole1a xcell ycell zcell",xcell,ycell,zcell 
      print*,"Empole1a xcell2 ycell2 zcell2",xcell2,ycell2,zcell2
      print*,"Empole1a xbox2 ybox2 zbox2",xbox2,ybox2,zbox2
      print*,"use_replica",use_replica
c
...
c     &            + rr5*scale5i*(sci(4)*uinp(1,i)+scip(4)*uind(1,i)
...
c     &            + rr5*scale5i*(sci(4)*uinp(2,i)+scip(4)*uind(2,i)
...
c     &            + rr5*scale5i*(sci(4)*uinp(3,i)+scip(4)*uind(3,i)
...
c               dep(3,ii) = dep(3,ii) + ftm2i(3)
               call torque_Perm (i,ttm2,frcxi,frcyi,frczi)
c
...
c               dep(3,kk) = dep(3,kk) - ftm2i(3)
               call torque_Perm (k,ttm3,frcxk,frcyk,frczk)
c
...
c     &                  + zky*frcyk(3) + zkz*frczk(3)
     ...
     &                  + zky*frcyk(3) + zkz*frczk(3)
               viremreal_tmp(1,1) = viremreal_tmp(1,1) + vxx
               viremreal_tmp(2,1) = viremreal_tmp(2,1) + vyx
               viremreal_tmp(3,1) = viremreal_tmp(3,1) + vzx
               viremreal_tmp(1,2) = viremreal_tmp(1,2) + vyx
               viremreal_tmp(2,2) = viremreal_tmp(2,2) + vyy
               viremreal_tmp(3,2) = viremreal_tmp(3,2) + vzy
               viremreal_tmp(1,3) = viremreal_tmp(1,3) + vzx
               viremreal_tmp(2,3) = viremreal_tmp(2,3) + vzy
               viremreal_tmp(3,3) = viremreal_tmp(3,3) + vzz
            end if
   10       continue
         end do
c
