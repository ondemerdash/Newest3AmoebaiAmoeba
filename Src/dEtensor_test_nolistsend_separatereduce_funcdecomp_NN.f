...
c
c
      program dEtensor_test_nolistsend_separatereduce_funcdecomp_NN 
      use sizes
      use atoms
      use bath
      use bndstr
...
c            listsend_vdw = .false.
      ...
      call grad_covemrecip_vandr_reduce_totfield_dEtensor_vir5
...
c     & (efindif(3)-efindif(1))/2.0d0/delx,analyticgz(2)
c                print*,"Finite Diff PolEng, PolGradz",
c     & (efindif_ep3b(3)-efindif_ep3b(1))/2.0d0/delx,analyticg_dep3bz(2)
c              end if
