c
c
      subroutine empole1a_3b_Polar_orig_nopriordir_fijscale2(npole3b,
...
c
             ...
             !  scaling(3)= abs(1/zr)
               ...
               do j = 1, 3
                  ftm2i(j) = f * ftm2i(j) *scaling(j)
                  ttm2i(j) = f * ttm2i(j) *scaling(j)
                  ttm3i(j) = f * ttm3i(j) *scaling(j)
               end do
...
c
               ...
               call torque_3b_new_fij(npole3b,pnum,deptemp,i,
...
c
               ...
               call torque_3b_new_fij(npole3b,pnum,deptemp,k,
