...
c      subroutine Innerloop2(moli1,ep3bt,virep3bt,dep3bt)
      subroutine LoadBalSmoothInnerloop2body(ep3bt,virep3bt,dep3bt)
      use sizes
      use atoms
      use atomid
      use molcul
...
c      print*,"Begin Inner2body start",start_polar(taskid)
c      print*,"Begin Inner2body last",last_polar(taskid)
...
!$OMP& Rcut2b,SwitchR2b,molnew,taskid,
!$OMP& Rcut2b2)
...
!$OMP END DO
!$OMP END PARALLEL
c      print*,"End Innerloop2body",ep3bt
...
c      subroutine Innerloop3(iter3,moli1,ep3bt,virep3bt,dep3bt)
      subroutine LoadBalSmoothInnerloop3body(ep3bt,virep3bt,dep3bt,
     & ntript)  
      use sizes
      use atoms
      use atomid
...
c      print*,"Begin Innerloop3"
c      print*,"taskid start_polar3",taskid,start_polar3(taskid)
c      print*,"taskid last_polar3",taskid,last_polar3(taskid)
c      print*,"Cobarcut3b Rcut2b",Cobarcut3b,Rcut2b
c      print*,"rtapr3b rtapr2b",rtapr3b,rtapr2b
...
!  NEED TO CORRECT VIRIAL W/ TAPERING FUNC
     ...
     &                  +dtapr3b_kz*ep3moli123*z(i)
            ...
            print*,"3body shellsum",shellsum,ep3moli123
        end if
        end do
      end do
!$OMP END DO
...
c      print*,"End Innerloop3body",ep3bt
