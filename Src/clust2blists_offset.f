      subroutine clust2blists_offset
      use sizes
      use molcul
      use neigh2clust
      use mpidat
...
c      if(first2b) then
         ...
         taskid_offset=taskid-clustcount
...
c                 end if
         ...
         if(listbcast) then
           if(allocated(elst2b)) deallocate(elst2b)
           if(allocated(nelst2b)) deallocate(nelst2b)
           if(allocated(domlstclust2b)) deallocate(domlstclust2b)
           if(allocated(xmold2b)) deallocate(xmold2b)
           if(allocated(ymold2b)) deallocate(ymold2b)
           if(allocated(zmold2b)) deallocate(zmold2b)
           if(allocated(ulst2b)) deallocate(ulst2b)
           if(allocated(nulst2b)) deallocate(nulst2b)
           if(allocated(doulstclust2b)) deallocate(doulstclust2b)
           if(allocated(xuold2b)) deallocate(xuold2b)
           if(allocated(yuold2b)) deallocate(yuold2b)
           if(allocated(zuold2b)) deallocate(zuold2b)
         end if
