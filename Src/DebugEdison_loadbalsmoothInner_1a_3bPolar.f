      ...
      subroutine LoadBalNew2SmoothInnerloop1_2cut_wskin(
...
c      print*,"12/17 Original Version!"
      print*,"LOADPolz taskid",taskid,start_polar(taskid),
     &        last_polar(taskid)
...
!$OMP& schedule(guided)
      do kouter=start_polar(taskid),last_polar(taskid)
        moli1=molnew(kouter)
        print*,"1st loop moli1,taskid",moli1,taskid
        do k1=1,nmollst(moli1)
          print*,"2nd loop taskid",taskid
