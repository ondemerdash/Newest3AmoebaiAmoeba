      ...
      subroutine empole1c_3b_PolarPerm(npole3b,pnum,
     ...
     &   emtemp,demtemp)
      ...
      real*8 emtemp,demtemp(3,npole3b),viremtemp(3,3)
      ...
      real*8 frcx(3),frcy(3),frcz(3),cii,dii,qii
...
c      end if
     ...
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      print*,"Done w emrecip1_3b_Polar_new in empole1c_3b_PolarPerm"

      call ereal1c_3b_PolarPerm(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      print*,"Done w ereal1c_3b_1bclust in empole1c_3b_PolarPerm"
     ...
     &   i,trq,trqi,frcx,frcy,frcz,demtemp,deptemp)
      ...
      print*,"Completed all steps of empole1c_3b_PolarPerm"
      return
      end
c
c     ################################################################
...
c
c
      subroutine ereal1c_3b_PolarPerm(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      use sizes
      use atoms
      use bound
