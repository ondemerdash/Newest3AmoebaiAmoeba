...
c
      module boxes2bclust
      implicit none
      real*8, allocatable :: xbox2b(:)
      real*8, allocatable :: ybox2b(:)
      real*8, allocatable :: zbox2b(:)
      real*8, allocatable :: alpha2b(:)
      real*8, allocatable :: beta2b(:)
      real*8, allocatable :: gamma2b(:)
      real*8, allocatable :: xbox2_2b(:)
      real*8, allocatable :: ybox2_2b(:)
      real*8, allocatable :: zbox2_2b(:)
      real*8, allocatable :: box34_2b(:)
      real*8, allocatable :: volbox2b(:)
      real*8, allocatable :: beta_sin2b(:)
      real*8, allocatable :: beta_cos2b(:)
      real*8, allocatable :: gamma_sin2b(:)
      real*8, allocatable :: gamma_cos2b(:)
      real*8, allocatable :: beta_term2b(:)
      real*8, allocatable :: gamma_term2b(:)
c      real*8 lvec(3,3)
      real*8, allocatable :: lvec2b(:,:,:)
c      real*8 recip(3,3)
      real*8, allocatable :: recip2b(:,:,:)
      logical, allocatable :: orthogonal2b(:)
      logical, allocatable :: monoclinic2b(:)
      logical, allocatable :: triclinic2b(:)
      logical, allocatable :: octahedron2b(:)
      character*10, allocatable :: spacegrp2b(:)
      save
      end
