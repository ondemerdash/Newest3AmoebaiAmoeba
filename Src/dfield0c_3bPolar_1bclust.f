      subroutine dfield0c_3b_vacomp1b(npole3b,pnum,field,fieldp,cnt)
      use sizes
      use atoms
      use boxes
      use ewald
...
c
      if(useboxclust) then
       !call udirect1_3b_newbox1bclust (npole3b,pnum,field,cnt)
      else
       call udirect1_3b_new (npole3b,pnum,field)
      end if
      !print*,"After udirect1_3b_new"
      do i = 1, npole3b
         do j = 1, 3
...
c
      ...
      if(mlistclust) then
c         call udirect2b_3b_vacomp1b(npole3b,pnum,field,fieldp,
c     &  cnt) 
c       !print*,"After udirect2b_3b_vacomp1b"
        if(useboxclust) then
        ! call udirect2b_3b_vacomp1btestbox1bclust(npole3b,pnum,field,
     &  !  fieldp,cnt)

        else
         call udirect2b_3b_vacomp1btest(npole3b,pnum,field,fieldp,
     &  cnt)
        end if
      else
         call udirect2a_3b_vacomptest (npole3b,pnum,field,fieldp,cnt)
       !print*,"After udirect2a_3b_vacomp1b"
      end if
...
c
c
      subroutine udirect2b_3b_vacomp1b(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
...
c
c
      subroutine udirect2a_3b_vacomp(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
...
c
c
      subroutine udirect2b_3b_vacomp1btest(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
...
c
c
      subroutine udirect2a_3b_vacomptest(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
