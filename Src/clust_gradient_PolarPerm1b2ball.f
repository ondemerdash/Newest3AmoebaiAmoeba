      subroutine clust_gradient_PolarPerm1b2ball(start,
     & last,moli1rmndr)
      use mpole
      use mpidat
      use deriv3b
...
c          else
c            call ClustEmpole1_1b_NoOmp
c     &  (ep3bt,virep3bt,dep3bt,ntript,start,last,moli1rmndr,ep1btmat,
c     &  dep1btmat,virep1btmat,em3bt,dem3bt,em1btmat,dem1btmat
c     &  )
...
c
     ...
     &       mpi_sum,mpi_comm_world,ierr)
      ...
      if(taskid.lt.numtasks_polar1) then
       ...
       call ClustEmpole1_2b_NoOmpAll2b
