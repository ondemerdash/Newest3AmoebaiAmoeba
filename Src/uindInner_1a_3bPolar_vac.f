      ...
      subroutine uindInnerloop1_Nocut(start,last,
...
c      use cell
      ...
      real*8 uindt(3,npole),uind2moli12(3,30),uind3moli123(3,30)
      real*8 uind(3,30)
...
!$OMP& Rcut2b2,uindt,start,last,nmol)
...
C
          ...
          r1=sqrt(r1_2)
          call empole1a_3b_Polar_orig_nopriordir_uind(npole3b,pnum,
     &    eptemp,deptemp,virtemp,uind)
          ep2moli12=eptemp
          do l1 = 1, npole3b
            i = pnum(l1)
            do j = 1, 3
              dep2moli12(j,l1)=deptemp(j,l1)
              uind2moli12(j,l1)=uind(j,l1)
            end do
          end do
          do i=1,3
            do j=1,3
...
c          do k2=1,nmollst(moli2)
c            moli3=mollst(k2,moli2)
     ...
     &          eptemp,deptemp,virtemp,uind)
                ...
                do l1 = 1,npole3b
                  ...
                  uind3moli123(1,l1) = uind(1,l1)
                  uind3moli123(2,l1) = uind(2,l1)
                  uind3moli123(3,l1) = uind(3,l1) 
                end do
                do i=1,3
                  do j=1,3
     ...
     &            eptemp,deptemp,virtemp,uind)
                  ...
                  do l1 = 1, npole3b
                    ...
                    do j = 1, 3
                     ...
                     uind3moli123(j,l1)=uind3moli123(j,l1)-uind(j,l1)
                    end do
                  end do
                  do i=1,3
                   do j=1,3
...
c               if (r3.le.1.0d12) then
     ...
     &            eptemp,deptemp,virtemp,uind)
                     ...
                     do l1 = 1, npole3b
                       ...
                       uind3moli123(j,l2)=uind3moli123(j,l2)-uind(j,l1)
                       end do
                     end do
                     do i=1,3
                       do j=1,3
