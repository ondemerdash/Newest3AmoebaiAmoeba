      ...
      subroutine empole1c_3b_PolarPermtest(npole3b,pnum,
...
c      end if
     ...
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      !print*,"Done empole1c_3b_PolarPermtest"

      call ereal1c_3b_PolarPermtest(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      !print*,"Done empole1c_3b_PolarPermtest"
     ...
     &   i,trq,trqi,frcx,frcy,frcz,demtemp,deptemp)
      ...
      !print*,"Completed all steps of empole1c_3b_PolarPermtest"
      return
      end
c
c     ################################################################
...
c
c
      subroutine ereal1c_3b_PolarPermtest(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      use sizes
      use atoms
      use bound
...
c
               demo1(1,i) = demo1(1,i) + ftm2(1)
               demo1(2,i) = demo1(2,i) + ftm2(2)
               demo1(3,i) = demo1(3,i) + ftm2(3)
               depo1(1,i) = depo1(1,i) + ftm2i(1)
               depo1(2,i) = depo1(2,i) + ftm2i(2)
               depo1(3,i) = depo1(3,i) + ftm2i(3)
               call torque3 (
...
c
               demo2(1,k) = demo2(1,k) - ftm2(1)
               demo2(2,k) = demo2(2,k) - ftm2(2)
               demo2(3,k) = demo2(3,k) - ftm2(3)
               depo2(1,k) = depo2(1,k) - ftm2i(1)
               depo2(2,k) = depo2(2,k) - ftm2i(2)
               depo2(3,k) = depo2(3,k) - ftm2i(3)
               call torque3 (
