c
      subroutine PrintAll2bAll3bNew2SmoothInnerloop1_2cut_wskin(
     &  start,last,ep3bt,virep3bt,dep3bt,ntript,moli1rmndr)
      ...
      SwitchR3b=Cobarcut3b-rtapr3b
       ...
       ntript=0
        ...
        print*,"In Print NOCut3b NoCut2b"
...
!$OMP& Rcut2b,SwitchR2b,SwitchR3b,ntript,nmol)
        ...
        do moli2=moli1+1,nmol
          ...
          if(r1.le.Rcut2b) then
           call empole1a_3b_Polar(npole3b,pnum,eptemp,deptemp,virtemp)
            print*,"2body r1 ep2body",r1,eptemp
              ep2moli12=eptemp
              do l1 = 1, npole3b
                i = pnum(l1)
                do j = 1, 3
