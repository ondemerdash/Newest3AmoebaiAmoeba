...
c     &  frcxtaulocal2d,frcxtaulocal2p,frcytaulocal2d,frcytaulocal2p,k)
      subroutine torque3_dEtensor_72015_taunew3_pt2_vir(i,trq2,
     &  taud,taup,nlocaltau2,
     &  nlocal,
     &  k,kkk,iter3)
      use sizes
      use atoms
...
c            depi(j,ib) = depi(j,ib) - du - dv
                ...
                elsttau2_tmp(1,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=duzz_p
                ...
                taud2tmp(1,nlocaltau2)=duxx_d
                taud2tmp(2,nlocaltau2)=duxy_d
                taud2tmp(3,nlocaltau2)=duxz_d
                taud2tmp(4,nlocaltau2)=duyx_d
                taud2tmp(5,nlocaltau2)=duyy_d
                taud2tmp(6,nlocaltau2)=duyz_d
                taud2tmp(7,nlocaltau2)=duzx_d
                taud2tmp(8,nlocaltau2)=duzy_d
                taud2tmp(9,nlocaltau2)=duzz_d

                taup2tmp(1,nlocaltau2)=duxx_p
                taup2tmp(2,nlocaltau2)=duxy_p
                taup2tmp(3,nlocaltau2)=duxz_p
                taup2tmp(4,nlocaltau2)=duyx_p
                taup2tmp(5,nlocaltau2)=duyy_p
                taup2tmp(6,nlocaltau2)=duyz_p
                taup2tmp(7,nlocaltau2)=duzx_p
                taup2tmp(8,nlocaltau2)=duzy_p
                taup2tmp(9,nlocaltau2)=duzz_p
...
c                frcztaulocal2p(9,nlocal)=duzz_p
                ...
                frcztau2d(1,nlocal)=duxx_d
                frcztau2d(2,nlocal)=duxy_d
                frcztau2d(3,nlocal)=duxz_d
                frcztau2d(4,nlocal)=duyx_d
                frcztau2d(5,nlocal)=duyy_d
                frcztau2d(6,nlocal)=duyz_d
                frcztau2d(7,nlocal)=duzx_d
                frcztau2d(8,nlocal)=duzy_d
                frcztau2d(9,nlocal)=duzz_d
                frcztau2p(1,nlocal)=duxx_p
                frcztau2p(2,nlocal)=duxy_p
                frcztau2p(3,nlocal)=duxz_p
                frcztau2p(4,nlocal)=duyx_p
                frcztau2p(5,nlocal)=duyy_p
                frcztau2p(6,nlocal)=duyz_p
                frcztau2p(7,nlocal)=duzx_p
                frcztau2p(8,nlocal)=duzy_p
                frcztau2p(9,nlocal)=duzz_p
...
c                frcxtaulocal2p(9,nlocal)=dvzz_p
                ...
                frcxtau2d(1,nlocal)=dvxx_d
                frcxtau2d(2,nlocal)=dvxy_d
                frcxtau2d(3,nlocal)=dvxz_d
                frcxtau2d(4,nlocal)=dvyx_d
                frcxtau2d(5,nlocal)=dvyy_d
                frcxtau2d(6,nlocal)=dvyz_d
                frcxtau2d(7,nlocal)=dvzx_d
                frcxtau2d(8,nlocal)=dvzy_d
                frcxtau2d(9,nlocal)=dvzz_d
                frcxtau2p(1,nlocal)=dvxx_p
                frcxtau2p(2,nlocal)=dvxy_p
                frcxtau2p(3,nlocal)=dvxz_p
                frcxtau2p(4,nlocal)=dvyx_p
                frcxtau2p(5,nlocal)=dvyy_p
                frcxtau2p(6,nlocal)=dvyz_p
                frcxtau2p(7,nlocal)=dvzx_p
                frcxtau2p(8,nlocal)=dvzy_p
                frcxtau2p(9,nlocal)=dvzz_p
...
c                frcytaulocal2p(9,nlocal)=0.0d0
                ...
                frcytau2d(1,nlocal)=0.0d0
                frcytau2d(2,nlocal)=0.0d0
                frcytau2d(3,nlocal)=0.0d0
                frcytau2d(4,nlocal)=0.0d0
                frcytau2d(5,nlocal)=0.0d0
                frcytau2d(6,nlocal)=0.0d0
                frcytau2d(7,nlocal)=0.0d0
                frcytau2d(8,nlocal)=0.0d0
                frcytau2d(9,nlocal)=0.0d0
                frcytau2p(1,nlocal)=0.0d0
                frcytau2p(2,nlocal)=0.0d0
                frcytau2p(3,nlocal)=0.0d0
                frcytau2p(4,nlocal)=0.0d0
                frcytau2p(5,nlocal)=0.0d0
                frcytau2p(6,nlocal)=0.0d0
                frcytau2p(7,nlocal)=0.0d0
                frcytau2p(8,nlocal)=0.0d0
                frcytau2p(9,nlocal)=0.0d0
...
c                ilocaltau2(2,nlocaltau2)=ic
                ...
                elsttau2_tmp(2,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=dvzz_p
                ...
                taud2tmp(1,nlocaltau2)=dvxx_d
                taud2tmp(2,nlocaltau2)=dvxy_d
                taud2tmp(3,nlocaltau2)=dvxz_d
                taud2tmp(4,nlocaltau2)=dvyx_d
                taud2tmp(5,nlocaltau2)=dvyy_d
                taud2tmp(6,nlocaltau2)=dvyz_d
                taud2tmp(7,nlocaltau2)=dvzx_d
                taud2tmp(8,nlocaltau2)=dvzy_d
                taud2tmp(9,nlocaltau2)=dvzz_d

                taup2tmp(1,nlocaltau2)=dvxx_p
                taup2tmp(2,nlocaltau2)=dvxy_p
                taup2tmp(3,nlocaltau2)=dvxz_p
                taup2tmp(4,nlocaltau2)=dvyx_p
                taup2tmp(5,nlocaltau2)=dvyy_p
                taup2tmp(6,nlocaltau2)=dvyz_p
                taup2tmp(7,nlocaltau2)=dvzx_p
                taup2tmp(8,nlocaltau2)=dvzy_p
                taup2tmp(9,nlocaltau2)=dvzz_p
...
c                ilocaltau2(2,nlocaltau2)=ib
                ...
                elsttau2_tmp(3,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=-duzz_p-dvzz_p
                ...
                taud2tmp(1,nlocaltau2)=-duxx_d-dvxx_d
                taud2tmp(2,nlocaltau2)=-duxy_d-dvxy_d
                taud2tmp(3,nlocaltau2)=-duxz_d-dvxz_d
                taud2tmp(4,nlocaltau2)=-duyx_d-dvyx_d
                taud2tmp(5,nlocaltau2)=-duyy_d-dvyy_d
                taud2tmp(6,nlocaltau2)=-duyz_d-dvyz_d
                taud2tmp(7,nlocaltau2)=-duzx_d-dvzx_d
                taud2tmp(8,nlocaltau2)=-duzy_d-dvzy_d
                taud2tmp(9,nlocaltau2)=-duzz_d-dvzz_d

                taup2tmp(1,nlocaltau2)=-duxx_p-dvxx_p
                taup2tmp(2,nlocaltau2)=-duxy_p-dvxy_p
                taup2tmp(3,nlocaltau2)=-duxz_p-dvxz_p
                taup2tmp(4,nlocaltau2)=-duyx_p-dvyx_p
                taup2tmp(5,nlocaltau2)=-duyy_p-dvyy_p
                taup2tmp(6,nlocaltau2)=-duyz_p-dvyz_p
                taup2tmp(7,nlocaltau2)=-duzx_p-dvzx_p
                taup2tmp(8,nlocaltau2)=-duzy_p-dvzy_p
                taup2tmp(9,nlocaltau2)=-duzz_p-dvzz_p
