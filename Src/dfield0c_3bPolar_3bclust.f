      subroutine dfield0c_3b_vacomp3b(npole3b,pnum,field,fieldp,cnt)
      use sizes
      use atoms
      use boxes
      use ewald
...
c
      if(useboxclust) then
       !call udirect1_3b_newbox3bclust (npole3b,pnum,field,cnt)
      else
...
c
        if(useboxclust) then
        ! call udirect3b_3b_vacomp3btestbox3bclust(npole3b,pnum,field,
     &  ! fieldp,cnt)
        else
         call udirect3b_3b_vacomp3btest(npole3b,pnum,field,fieldp,
     &  cnt) 
        end if
c
...
c
c
      subroutine udirect3b_3b_vacomp3b(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
...
c
c
      subroutine udirect3b_3b_vacomp3btest(npole3b,pnum,field,fieldp,
     &  cnt)
      use sizes
      use atoms
      use bound
