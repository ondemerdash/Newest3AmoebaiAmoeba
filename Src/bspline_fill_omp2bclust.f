...
c
c
      subroutine bspline_fill_omp2bclust(cnt)
      use sizes
      use atoms
      use boxes
      use boxes2bclust
...
!$OMP DO
      ...
      do i = 1, n
         ...
         yi = y(i)
         zi = z(i)
         w = xi*recip2b(1,1,cnt) + yi*recip2b(2,1,cnt) 
     &        + zi*recip2b(3,1,cnt)
         ...
         w = xi*recip2b(1,2,cnt) + yi*recip2b(2,2,cnt) 
     &         + zi*recip2b(3,2,cnt)
         ...
         w = xi*recip2b(1,3,cnt) + yi*recip2b(2,3,cnt) 
     &        + zi*recip2b(3,3,cnt)
