c
      subroutine totfieldNpoleloadbalsmoothInner_1c_3bPolar_dEtensorMpi1
     &  (ep3bt,virep3bt,dep3bt)
      ...
      SwitchR3b=Cobarcut3b-rtapr3b
        ...
        print*,"Nn 3BODY MODE TOTFIELD DETENSOR!!"
...
!$OMP& schedule(guided)
      ...
      do moli1=start_polar(taskid),last_polar(taskid)
          ...
          pnum(3)=imol(2,moli1)
          npole3b=3
           call Newempole1c_3b_Polar_totfield_dEtensor2_1(npole3b,pnum,
...
c              print*,"i j dep1moli1(j,i)",i,j,dep1moli1(j,i)
          ...
          do k2=1,nmollst(moli2)
            ...
            if ((r1.lt.r3).and.(r2.lt.r3) ) then
              ...
              if (shellsum.le.Cobarcut3b) then            
                 call Newempole1c_3b_Polar_totfield_dEtensor2_1(npole3b,
     &           pnum,ep3moli123,dep3moli123,vir3moli123)
                 !ep3moli123=eptemp
                 !do i =1,npole
     ...
     &           pnum,eptemp,deptemp,virtemp)
                 ...
                 pnum(3)=imol(2,moli3)
                 call Newempole1c_3b_Polar_totfield_dEtensor2_1(
