...
c
c
      subroutine torque3_dEtensor_72015_taunew2_pt1_vir(i,trq1,trq2,
     &  frcx,frcy,frcz,demi,taud,taup,nlocaltau1,ilocaltau1,taulocal1d,
     &   taulocal1p,nlocal,frcztaulocal1d,frcztaulocal1p,
...
c      real*8 depi(3,*)
      ...
      integer nlocaltau1,ilocaltau1(2,*),ikflag,k,m
      real*8 taulocal1d(9,*),taulocal1p(9,*)
      ...
      integer nlocal
      real*8 frcztaulocal1d(9,*),frcztaulocal1p(9,*)
      real*8 frcxtaulocal1d(9,*),frcxtaulocal1p(9,*)
      real*8 frcytaulocal1d(9,*),frcytaulocal1p(9,*)
c
c
...
c            depi(j,ib) = depi(j,ib) - du - dv
                ...
                nlocaltau1=nlocaltau1+1
                ilocaltau1(1,nlocaltau1)=ia
                ilocaltau1(2,nlocaltau1)=k
                taulocal1d(1,nlocaltau1)=duxx_d
                taulocal1d(2,nlocaltau1)=duxy_d
                taulocal1d(3,nlocaltau1)=duxz_d
                taulocal1d(4,nlocaltau1)=duyx_d
                taulocal1d(5,nlocaltau1)=duyy_d
                taulocal1d(6,nlocaltau1)=duyz_d
                taulocal1d(7,nlocaltau1)=duzx_d
                taulocal1d(8,nlocaltau1)=duzy_d
                taulocal1d(9,nlocaltau1)=duzz_d
                taulocal1p(1,nlocaltau1)=duxx_p
                taulocal1p(2,nlocaltau1)=duxy_p
                taulocal1p(3,nlocaltau1)=duxz_p
                taulocal1p(4,nlocaltau1)=duyx_p
                taulocal1p(5,nlocaltau1)=duyy_p
                taulocal1p(6,nlocaltau1)=duyz_p
                taulocal1p(7,nlocaltau1)=duzx_p
                taulocal1p(8,nlocaltau1)=duzy_p
                taulocal1p(9,nlocaltau1)=duzz_p
c            frcz(j) = frcz(j) + du
c            frcx(j) = frcx(j) + dv           
c         end do

                frcztaulocal1d(1,nlocal)=duxx_d
                frcztaulocal1d(2,nlocal)=duxy_d
                frcztaulocal1d(3,nlocal)=duxz_d
                frcztaulocal1d(4,nlocal)=duyx_d
                frcztaulocal1d(5,nlocal)=duyy_d
                frcztaulocal1d(6,nlocal)=duyz_d
                frcztaulocal1d(7,nlocal)=duzx_d
                frcztaulocal1d(8,nlocal)=duzy_d
                frcztaulocal1d(9,nlocal)=duzz_d
                frcztaulocal1p(1,nlocal)=duxx_p
                frcztaulocal1p(2,nlocal)=duxy_p
                frcztaulocal1p(3,nlocal)=duxz_p
                frcztaulocal1p(4,nlocal)=duyx_p
                frcztaulocal1p(5,nlocal)=duyy_p
                frcztaulocal1p(6,nlocal)=duyz_p
                frcztaulocal1p(7,nlocal)=duzx_p
                frcztaulocal1p(8,nlocal)=duzy_p
                frcztaulocal1p(9,nlocal)=duzz_p

                frcxtaulocal1d(1,nlocal)=dvxx_d
                frcxtaulocal1d(2,nlocal)=dvxy_d
                frcxtaulocal1d(3,nlocal)=dvxz_d
                frcxtaulocal1d(4,nlocal)=dvyx_d
                frcxtaulocal1d(5,nlocal)=dvyy_d
                frcxtaulocal1d(6,nlocal)=dvyz_d
                frcxtaulocal1d(7,nlocal)=dvzx_d
                frcxtaulocal1d(8,nlocal)=dvzy_d
                frcxtaulocal1d(9,nlocal)=dvzz_d
                frcxtaulocal1p(1,nlocal)=dvxx_p
                frcxtaulocal1p(2,nlocal)=dvxy_p
                frcxtaulocal1p(3,nlocal)=dvxz_p
                frcxtaulocal1p(4,nlocal)=dvyx_p
                frcxtaulocal1p(5,nlocal)=dvyy_p
                frcxtaulocal1p(6,nlocal)=dvyz_p
                frcxtaulocal1p(7,nlocal)=dvzx_p
                frcxtaulocal1p(8,nlocal)=dvzy_p
                frcxtaulocal1p(9,nlocal)=dvzz_p

                frcytaulocal1d(1,nlocal)=0.0d0
                frcytaulocal1d(2,nlocal)=0.0d0
                frcytaulocal1d(3,nlocal)=0.0d0
                frcytaulocal1d(4,nlocal)=0.0d0
                frcytaulocal1d(5,nlocal)=0.0d0
                frcytaulocal1d(6,nlocal)=0.0d0
                frcytaulocal1d(7,nlocal)=0.0d0
                frcytaulocal1d(8,nlocal)=0.0d0
                frcytaulocal1d(9,nlocal)=0.0d0
                frcytaulocal1p(1,nlocal)=0.0d0
                frcytaulocal1p(2,nlocal)=0.0d0
                frcytaulocal1p(3,nlocal)=0.0d0
                frcytaulocal1p(4,nlocal)=0.0d0
                frcytaulocal1p(5,nlocal)=0.0d0
                frcytaulocal1p(6,nlocal)=0.0d0
                frcytaulocal1p(7,nlocal)=0.0d0
                frcytaulocal1p(8,nlocal)=0.0d0
                frcytaulocal1p(9,nlocal)=0.0d0


                nlocaltau1=nlocaltau1+1
                ilocaltau1(1,nlocaltau1)=ic
                ilocaltau1(2,nlocaltau1)=k
                taulocal1d(1,nlocaltau1)=dvxx_d
                taulocal1d(2,nlocaltau1)=dvxy_d
                taulocal1d(3,nlocaltau1)=dvxz_d
                taulocal1d(4,nlocaltau1)=dvyx_d
                taulocal1d(5,nlocaltau1)=dvyy_d
                taulocal1d(6,nlocaltau1)=dvyz_d
                taulocal1d(7,nlocaltau1)=dvzx_d
                taulocal1d(8,nlocaltau1)=dvzy_d
                taulocal1d(9,nlocaltau1)=dvzz_d
                taulocal1p(1,nlocaltau1)=dvxx_p
                taulocal1p(2,nlocaltau1)=dvxy_p
                taulocal1p(3,nlocaltau1)=dvxz_p
                taulocal1p(4,nlocaltau1)=dvyx_p
                taulocal1p(5,nlocaltau1)=dvyy_p
                taulocal1p(6,nlocaltau1)=dvyz_p
                taulocal1p(7,nlocaltau1)=dvzx_p
                taulocal1p(8,nlocaltau1)=dvzy_p
                taulocal1p(9,nlocaltau1)=dvzz_p

                nlocaltau1=nlocaltau1+1
                ilocaltau1(1,nlocaltau1)=ib
                ilocaltau1(2,nlocaltau1)=k
                taulocal1d(1,nlocaltau1)= -duxx_d-dvxx_d
                taulocal1d(2,nlocaltau1)= -duxy_d-dvxy_d
                taulocal1d(3,nlocaltau1)= -duxz_d-dvxz_d
                taulocal1d(4,nlocaltau1)= -duyx_d-dvyx_d
                taulocal1d(5,nlocaltau1)= -duyy_d-dvyy_d
                taulocal1d(6,nlocaltau1)= -duyz_d-dvyz_d
                taulocal1d(7,nlocaltau1)= -duzx_d-dvzx_d
                taulocal1d(8,nlocaltau1)= -duzy_d-dvzy_d
                taulocal1d(9,nlocaltau1)= -duzz_d-dvzz_d
                taulocal1p(1,nlocaltau1)= -duxx_p-dvxx_p
                taulocal1p(2,nlocaltau1)= -duxy_p-dvxy_p
                taulocal1p(3,nlocaltau1)= -duxz_p-dvxz_p
                taulocal1p(4,nlocaltau1)= -duyx_p-dvyx_p
                taulocal1p(5,nlocaltau1)= -duyy_p-dvyy_p
                taulocal1p(6,nlocaltau1)= -duyz_p-dvyz_p
                taulocal1p(7,nlocaltau1)= -duzx_p-dvzx_p
                taulocal1p(8,nlocaltau1)= -duzy_p-dvzy_p
                taulocal1p(9,nlocaltau1)= -duzz_p-dvzz_p
c
c     force distribution for the Bisector local coordinate method
c     WATER AXETYP 
      else if (axetyp .eq. 'Bisector') then
