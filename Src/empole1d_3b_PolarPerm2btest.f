      subroutine empole1d_3b_PolarPerm2btest(npole3b,pnum,
...
c      end if
     ...
     & eptemp,deptemp,virtemp,emtemp,demtemp)
      ...
      call ereal1d_3b_2bclustPolarPermtest(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp,emtemp,demtemp)
...
c     &    i,trq,trqi,frcx,frcy,frcz,demtemp,deptemp)
     ...
     &    i,trq,trqi,frcx,frcy,frcz,demtemp,deptemp)
            ...
            t2=mpi_Wtime()
       !print*,"tsk=",taskid,"TotalCost Within empole1d_3b_2btest",t2-t1
...
c
c
      subroutine ereal1d_3b_2bclustPolarPermtest(npole3b,pnum,uind,uinp,
