...
c
c
      subroutine LoadBalInnerloop_ereal1d_3b_Perm_nolistsend(
     & emrealt,viremrealt,demrealt)
      ...
      integer atomind,iter3,taskid_offset
...
c      print*,"FckLoadBalEreal1d",taskid,start_emreal2(taskid_offset),
c     &  last_emreal2(taskid_offset)
