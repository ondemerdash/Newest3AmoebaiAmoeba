...
c
      ...
      nlocal = 0
      toffset0 = 0
c      maxlocal = int((npole*maxelst)/nthread)
...
c
     ...
     &         i,ttm2,ttm2i,frcxi,frcyi,frczi)
               ...
               !call torque3_dEtensor(i,ttm2,ttm2i,
     &         !frcxi,frcyi,frczi,demi,tau1d,tau1p,
     &         !nlocal,ilocal,dlocal1d,dlocal1p,1)
     &
c
...
c
     ...
     &          k,ttm3,ttm3i,frcxk,frcyk,frczk)
               ...
               !call torque_dEtensor(k,ttm3,ttm3i,
     &         !frcxk,frcyk,frczk,demk,tau2d,tau2p,
     &         !nlocal,ilocal,dlocal2d,dlocal2p,2)
