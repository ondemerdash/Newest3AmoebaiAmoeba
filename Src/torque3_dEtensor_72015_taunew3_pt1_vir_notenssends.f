...
c
c
      subroutine torque3_dEtensor_72015_taunew3_pt1_vir_notenssends(
     &  i,trq2,taud,taup,nlocaltau1,
     &   nlocal,
     &  k,kkk)
      use sizes
      use atoms
...
c                taulocal1p(9,nlocaltau1)=duzz_p
                ...
                taud1(1,nlocaltau1)=duxx_d
                taud1(2,nlocaltau1)=duxy_d
                taud1(3,nlocaltau1)=duxz_d
                taud1(4,nlocaltau1)=duyx_d
                taud1(5,nlocaltau1)=duyy_d
                taud1(6,nlocaltau1)=duyz_d
                taud1(7,nlocaltau1)=duzx_d
                taud1(8,nlocaltau1)=duzy_d
                taud1(9,nlocaltau1)=duzz_d
                taup1(1,nlocaltau1)=duxx_p
                taup1(2,nlocaltau1)=duxy_p
                taup1(3,nlocaltau1)=duxz_p
                taup1(4,nlocaltau1)=duyx_p
                taup1(5,nlocaltau1)=duyy_p
                taup1(6,nlocaltau1)=duyz_p
                taup1(7,nlocaltau1)=duzx_p
                taup1(8,nlocaltau1)=duzy_p
                taup1(9,nlocaltau1)=duzz_p
...
c                frcztaulocal1p(9,nlocal)=duzz_p
                ...
                frcztau1dtot(1,nlocal)=duxx_d
                frcztau1dtot(2,nlocal)=duxy_d
                frcztau1dtot(3,nlocal)=duxz_d
                frcztau1dtot(4,nlocal)=duyx_d
                frcztau1dtot(5,nlocal)=duyy_d
                frcztau1dtot(6,nlocal)=duyz_d
                frcztau1dtot(7,nlocal)=duzx_d
                frcztau1dtot(8,nlocal)=duzy_d
                frcztau1dtot(9,nlocal)=duzz_d
                frcztau1ptot(1,nlocal)=duxx_p
                frcztau1ptot(2,nlocal)=duxy_p
                frcztau1ptot(3,nlocal)=duxz_p
                frcztau1ptot(4,nlocal)=duyx_p
                frcztau1ptot(5,nlocal)=duyy_p
                frcztau1ptot(6,nlocal)=duyz_p
                frcztau1ptot(7,nlocal)=duzx_p
                frcztau1ptot(8,nlocal)=duzy_p
                frcztau1ptot(9,nlocal)=duzz_p
...
c                frcxtaulocal1p(9,nlocal)=dvzz_p
                ...
                frcxtau1dtot(1,nlocal)=dvxx_d
                frcxtau1dtot(2,nlocal)=dvxy_d
                frcxtau1dtot(3,nlocal)=dvxz_d
                frcxtau1dtot(4,nlocal)=dvyx_d
                frcxtau1dtot(5,nlocal)=dvyy_d
                frcxtau1dtot(6,nlocal)=dvyz_d
                frcxtau1dtot(7,nlocal)=dvzx_d
                frcxtau1dtot(8,nlocal)=dvzy_d
                frcxtau1dtot(9,nlocal)=dvzz_d
                frcxtau1ptot(1,nlocal)=dvxx_p
                frcxtau1ptot(2,nlocal)=dvxy_p
                frcxtau1ptot(3,nlocal)=dvxz_p
                frcxtau1ptot(4,nlocal)=dvyx_p
                frcxtau1ptot(5,nlocal)=dvyy_p
                frcxtau1ptot(6,nlocal)=dvyz_p
                frcxtau1ptot(7,nlocal)=dvzx_p
                frcxtau1ptot(8,nlocal)=dvzy_p
                frcxtau1ptot(9,nlocal)=dvzz_p
...
c                frcytaulocal1p(9,nlocal)=0.0d0
                ...
                frcytau1dtot(1,nlocal)=0.0d0
                frcytau1dtot(2,nlocal)=0.0d0
                frcytau1dtot(3,nlocal)=0.0d0
                frcytau1dtot(4,nlocal)=0.0d0
                frcytau1dtot(5,nlocal)=0.0d0
                frcytau1dtot(6,nlocal)=0.0d0
                frcytau1dtot(7,nlocal)=0.0d0
                frcytau1dtot(8,nlocal)=0.0d0
                frcytau1dtot(9,nlocal)=0.0d0
                frcytau1ptot(1,nlocal)=0.0d0
                frcytau1ptot(2,nlocal)=0.0d0
                frcytau1ptot(3,nlocal)=0.0d0
                frcytau1ptot(4,nlocal)=0.0d0
                frcytau1ptot(5,nlocal)=0.0d0
                frcytau1ptot(6,nlocal)=0.0d0
                frcytau1ptot(7,nlocal)=0.0d0
                frcytau1ptot(8,nlocal)=0.0d0
                frcytau1ptot(9,nlocal)=0.0d0
...
c                taulocal1p(9,nlocaltau1)=dvzz_p
                ...
                taud1(1,nlocaltau1)=dvxx_d
                taud1(2,nlocaltau1)=dvxy_d
                taud1(3,nlocaltau1)=dvxz_d
                taud1(4,nlocaltau1)=dvyx_d
                taud1(5,nlocaltau1)=dvyy_d
                taud1(6,nlocaltau1)=dvyz_d
                taud1(7,nlocaltau1)=dvzx_d
                taud1(8,nlocaltau1)=dvzy_d
                taud1(9,nlocaltau1)=dvzz_d
                taup1(1,nlocaltau1)=dvxx_p
                taup1(2,nlocaltau1)=dvxy_p
                taup1(3,nlocaltau1)=dvxz_p
                taup1(4,nlocaltau1)=dvyx_p
                taup1(5,nlocaltau1)=dvyy_p
                taup1(6,nlocaltau1)=dvyz_p
                taup1(7,nlocaltau1)=dvzx_p
                taup1(8,nlocaltau1)=dvzy_p
                taup1(9,nlocaltau1)=dvzz_p
...
c                taulocal1p(9,nlocaltau1)= -duzz_p-dvzz_p
                ...
                taud1(1,nlocaltau1)= -duxx_d-dvxx_d
                taud1(2,nlocaltau1)= -duxy_d-dvxy_d
                taud1(3,nlocaltau1)= -duxz_d-dvxz_d
                taud1(4,nlocaltau1)= -duyx_d-dvyx_d
                taud1(5,nlocaltau1)= -duyy_d-dvyy_d
                taud1(6,nlocaltau1)= -duyz_d-dvyz_d
                taud1(7,nlocaltau1)= -duzx_d-dvzx_d
                taud1(8,nlocaltau1)= -duzy_d-dvzy_d
                taud1(9,nlocaltau1)= -duzz_d-dvzz_d
                taup1(1,nlocaltau1)= -duxx_p-dvxx_p
                taup1(2,nlocaltau1)= -duxy_p-dvxy_p
                taup1(3,nlocaltau1)= -duxz_p-dvxz_p
                taup1(4,nlocaltau1)= -duyx_p-dvyx_p
                taup1(5,nlocaltau1)= -duyy_p-dvyy_p
                taup1(6,nlocaltau1)= -duyz_p-dvyz_p
                taup1(7,nlocaltau1)= -duzx_p-dvzx_p
                taup1(8,nlocaltau1)= -duzy_p-dvzy_p
                taup1(9,nlocaltau1)= -duzz_p-dvzz_p
