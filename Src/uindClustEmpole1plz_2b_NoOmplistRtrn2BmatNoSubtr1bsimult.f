      ...
      subroutine uindClustEmpole1plz2b_NoOmplistRtrn2BmatNoSubtr1bsimult
     &  (ep3bt,virep3bt,dep3bt,ntript,ep2btmat,dep2btmat,
     &   virep2btmat,uind2bt,uind2btmat) 
      use sizes
      use atoms
      use atomid
      use molcul
...
c      real*8 em3bt,dem3bt(3,npole)
      ...
      real*8 uind2bt(3,npole),uind2btmat(3,2*3*maxsizeclust,num2bsave)
...
c          cnt=cnt+1
     ...
     &    !     ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
            !else
            call uindempole1d_3b_Polar2btest2(npole3b,pnum,
...
c                  dem3bt(j,i) = dem3bt(j,i)+dem2moli12(j,l1)
                  ...
                  uind2bt(j,i) = uind2bt(j,i)+uind(j,l1)
