...
c           end do
   21    continue
c           if(in_npole3b.eqv..false.) then
             do k=1,nelst2(j)
...
c             termx=uinp(1,l3)*t1xxd+ uinp(2,l3)*t1xyd + uinp(3,l3)*t1xzd
c             termy=uinp(1,l3)*t1yxd+ uinp(2,l3)*t1yyd + uinp(3,l3)*t1yzd
c             termz=uinp(1,l3)*t1zxd+ uinp(2,l3)*t1zyd + uinp(3,l3)*t1zzd
c
c             frczi(1)=uinp(1,l3)*frcz1xxd+uinp(2,l3)*frcz1xyd
c     &                +uinp(3,l3)*frcz1xzd
c             frczi(2)=uinp(1,l3)*frcz1yxd+uinp(2,l3)*frcz1yyd
c     &                +uinp(3,l3)*frcz1yzd
c             frczi(3)=uinp(1,l3)*frcz1zxd+uinp(2,l3)*frcz1zyd
c     &                +uinp(3,l3)*frcz1zzd
c         
c             frcxi(1)=uinp(1,l3)*frcx1xxd+uinp(2,l3)*frcx1xyd
c     &                +uinp(3,l3)*frcx1xzd
c             frcxi(2)=uinp(1,l3)*frcx1yxd+uinp(2,l3)*frcx1yyd
c     &                +uinp(3,l3)*frcx1yzd
c             frcxi(3)=uinp(1,l3)*frcx1zxd+uinp(2,l3)*frcx1zyd
c     &                +uinp(3,l3)*frcx1zzd
c          
c             frcyi(1)=uinp(1,l3)*frcy1xxd+uinp(2,l3)*frcy1xyd
c     &                +uinp(3,l3)*frcy1xzd
c             frcyi(2)=uinp(1,l3)*frcy1yxd+uinp(2,l3)*frcy1yyd
c     &                +uinp(3,l3)*frcy1yzd
c             frcyi(3)=uinp(1,l3)*frcy1zxd+uinp(2,l3)*frcy1zyd
c     &                +uinp(3,l3)*frcy1zzd
c
c             deptemp(1,i)=deptemp(1,i)+termx
c             deptemp(2,i)=deptemp(2,i)+termy
c             deptemp(3,i)=deptemp(3,i)+termz
...
c
c            taux=uinp(1,l3)*tau1xxd+ uinp(2,l3)*tau1xyd 
c     &           +uinp(3,l3)*tau1xzd
c            tauy=uinp(1,l3)*tau1yxd+ uinp(2,l3)*tau1yyd 
c     &           +uinp(3,l3)*tau1yzd
c            tauz=uinp(1,l3)*tau1zxd+ uinp(2,l3)*tau1zyd 
c     &           +uinp(3,l3)*tau1zzd
c
c
c            deptemp(1,k1)=deptemp(1,k1)+taux
