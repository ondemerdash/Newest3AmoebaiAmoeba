      subroutine gradient_emreal_serial_totfield
      use mpole
      use mpidat
      use deriv
      use energi
...
c      print*,"Before call to LoadBalInnerloop_ereal1d_3b_Perm_sentlist2"
      ...
      call LoadBalInnerloop_ereal1d_3b_Perm_sentlist2_totfield(
...
c            fieldnpole(j,i) = fieldnpole(j,i) +fieldnpole_rcp(j,i)
c            fieldpnpole(j,i) = fieldpnpole(j,i) +fieldnpole_rcp(j,i)
c            fieldnpole(j,i) = fieldnpole(j,i) + term*rpole(j+1,i)
c            fieldpnpole(j,i) = fieldpnpole(j,i) + term*rpole(j+1,i)
         end do
       end do
