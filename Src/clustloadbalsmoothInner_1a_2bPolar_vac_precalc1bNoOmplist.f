      ...
      subroutine ClustLoadBalNew2SmoothInnerloop1_2b_Precalc1bNoOmplist
...
c            call empole1d_3b_Polar_orig_nopriordiromp2b(npole3b,pnum,
c     &         ep2moli12,dep2moli12,vir2moli12,cnt)
c           else
            call empole1b_3b_Polar_orig_nopriordiromp2b(npole3b,pnum,
     &         ep2moli12,dep2moli12,vir2moli12,cnt)
c           end if
...
c     &                          +dtapr2b_x(l1)*ep2moli12*xr1
c              virep3bt(2,1)=virep3bt(2,1)
c     &                          +dtapr2b_x(l1)*ep2moli12*yr1
c              virep3bt(3,1)=virep3bt(3,1)
c     &                           +dtapr2b_x(l1)*ep2moli12*zr1
c              virep3bt(1,2)=virep3bt(2,1)
c              virep3bt(2,2)=virep3bt(2,2)
c     &                           +dtapr2b_y(l1)*ep2moli12*yr1
c              virep3bt(3,2)=virep3bt(3,2)
c     &                           +dtapr2b_y(l1)*ep2moli12*zr1
c              virep3bt(1,3)=virep3bt(3,1)
c              virep3bt(2,3)=virep3bt(3,2)
c              virep3bt(3,3)=virep3bt(3,3)
c     &                           +dtapr2b_z(l1)*ep2moli12*zr1
c
c               end if
c            end do
c            do l1=np1+1,npole3b
