...
c     &  frcxtaulocal2d,frcxtaulocal2p,frcytaulocal2d,frcytaulocal2p,k)
      subroutine torque3_dEtensor_72015_taunew3_pt2_vir2(
     &  i,trq2,taud,taup,
     &  k,kkk,iter3)
      use sizes
      use atoms
...
c                nlocaltau2=nlocaltau2+1
                elsttau2_index_tmp(1,kkk,iter3)=ia
c                elsttau2(1,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=duzz_p
                ...
                taud2_3tmp(1,1,kkk,iter3)=duxx_d
                taud2_3tmp(2,1,kkk,iter3)=duxy_d
                taud2_3tmp(3,1,kkk,iter3)=duxz_d
                taud2_3tmp(4,1,kkk,iter3)=duyx_d
                taud2_3tmp(5,1,kkk,iter3)=duyy_d
                taud2_3tmp(6,1,kkk,iter3)=duyz_d
                taud2_3tmp(7,1,kkk,iter3)=duzx_d
                taud2_3tmp(8,1,kkk,iter3)=duzy_d
                taud2_3tmp(9,1,kkk,iter3)=duzz_d

                taup2_3tmp(1,1,kkk,iter3)=duxx_p
                taup2_3tmp(2,1,kkk,iter3)=duxy_p
                taup2_3tmp(3,1,kkk,iter3)=duxz_p
                taup2_3tmp(4,1,kkk,iter3)=duyx_p
                taup2_3tmp(5,1,kkk,iter3)=duyy_p
                taup2_3tmp(6,1,kkk,iter3)=duyz_p
                taup2_3tmp(7,1,kkk,iter3)=duzx_p
                taup2_3tmp(8,1,kkk,iter3)=duzy_p
                taup2_3tmp(9,1,kkk,iter3)=duzz_p
...
c                frcztaulocal2p(9,nlocal)=duzz_p
                ...
                frcztau2dtot_3tmp(1,kkk,iter3)=duxx_d
                frcztau2dtot_3tmp(2,kkk,iter3)=duxy_d
                frcztau2dtot_3tmp(3,kkk,iter3)=duxz_d
                frcztau2dtot_3tmp(4,kkk,iter3)=duyx_d
                frcztau2dtot_3tmp(5,kkk,iter3)=duyy_d
                frcztau2dtot_3tmp(6,kkk,iter3)=duyz_d
                frcztau2dtot_3tmp(7,kkk,iter3)=duzx_d
                frcztau2dtot_3tmp(8,kkk,iter3)=duzy_d
                frcztau2dtot_3tmp(9,kkk,iter3)=duzz_d
                frcztau2ptot_3tmp(1,kkk,iter3)=duxx_p
                frcztau2ptot_3tmp(2,kkk,iter3)=duxy_p
                frcztau2ptot_3tmp(3,kkk,iter3)=duxz_p
                frcztau2ptot_3tmp(4,kkk,iter3)=duyx_p
                frcztau2ptot_3tmp(5,kkk,iter3)=duyy_p
                frcztau2ptot_3tmp(6,kkk,iter3)=duyz_p
                frcztau2ptot_3tmp(7,kkk,iter3)=duzx_p
                frcztau2ptot_3tmp(8,kkk,iter3)=duzy_p
                frcztau2ptot_3tmp(9,kkk,iter3)=duzz_p
...
c                frcxtaulocal2p(9,nlocal)=dvzz_p
                ...
                frcxtau2dtot_3tmp(1,kkk,iter3)=dvxx_d
                frcxtau2dtot_3tmp(2,kkk,iter3)=dvxy_d
                frcxtau2dtot_3tmp(3,kkk,iter3)=dvxz_d
                frcxtau2dtot_3tmp(4,kkk,iter3)=dvyx_d
                frcxtau2dtot_3tmp(5,kkk,iter3)=dvyy_d
                frcxtau2dtot_3tmp(6,kkk,iter3)=dvyz_d
                frcxtau2dtot_3tmp(7,kkk,iter3)=dvzx_d
                frcxtau2dtot_3tmp(8,kkk,iter3)=dvzy_d
                frcxtau2dtot_3tmp(9,kkk,iter3)=dvzz_d
                frcxtau2ptot_3tmp(1,kkk,iter3)=dvxx_p
                frcxtau2ptot_3tmp(2,kkk,iter3)=dvxy_p
                frcxtau2ptot_3tmp(3,kkk,iter3)=dvxz_p
                frcxtau2ptot_3tmp(4,kkk,iter3)=dvyx_p
                frcxtau2ptot_3tmp(5,kkk,iter3)=dvyy_p
                frcxtau2ptot_3tmp(6,kkk,iter3)=dvyz_p
                frcxtau2ptot_3tmp(7,kkk,iter3)=dvzx_p
                frcxtau2ptot_3tmp(8,kkk,iter3)=dvzy_p
                frcxtau2ptot_3tmp(9,kkk,iter3)=dvzz_p
...
c                frcytaulocal2p(9,nlocal)=0.0d0
                ...
                frcytau2dtot_3tmp(1,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(2,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(3,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(4,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(5,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(6,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(7,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(8,kkk,iter3)=0.0d0
                frcytau2dtot_3tmp(9,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(1,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(2,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(3,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(4,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(5,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(6,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(7,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(8,kkk,iter3)=0.0d0
                frcytau2ptot_3tmp(9,kkk,iter3)=0.0d0

 
c                nlocaltau2=nlocaltau2+1
c                ilocaltau2(1,nlocaltau2)=i
c                ilocaltau2(2,nlocaltau2)=ic
                elsttau2_index_tmp(2,kkk,iter3)=ic
c                elsttau2(2,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=dvzz_p
                ...
                taud2_3tmp(1,2,kkk,iter3)=dvxx_d
                taud2_3tmp(2,2,kkk,iter3)=dvxy_d
                taud2_3tmp(3,2,kkk,iter3)=dvxz_d
                taud2_3tmp(4,2,kkk,iter3)=dvyx_d
                taud2_3tmp(5,2,kkk,iter3)=dvyy_d
                taud2_3tmp(6,2,kkk,iter3)=dvyz_d
                taud2_3tmp(7,2,kkk,iter3)=dvzx_d
                taud2_3tmp(8,2,kkk,iter3)=dvzy_d
                taud2_3tmp(9,2,kkk,iter3)=dvzz_d

                taup2_3tmp(1,2,kkk,iter3)=dvxx_p
                taup2_3tmp(2,2,kkk,iter3)=dvxy_p
                taup2_3tmp(3,2,kkk,iter3)=dvxz_p
                taup2_3tmp(4,2,kkk,iter3)=dvyx_p
                taup2_3tmp(5,2,kkk,iter3)=dvyy_p
                taup2_3tmp(6,2,kkk,iter3)=dvyz_p
                taup2_3tmp(7,2,kkk,iter3)=dvzx_p
                taup2_3tmp(8,2,kkk,iter3)=dvzy_p
                taup2_3tmp(9,2,kkk,iter3)=dvzz_p


c                nlocaltau2=nlocaltau2+1
c                ilocaltau2(1,nlocaltau2)=i
c                ilocaltau2(2,nlocaltau2)=ib
                elsttau2_index_tmp(3,kkk,iter3)=ib
c                elsttau2(3,kkk,iter3)=nlocaltau2
...
c                taulocal2p(9,nlocaltau2)=-duzz_p-dvzz_p
                ...
                taud2_3tmp(1,3,kkk,iter3)=-duxx_d-dvxx_d
                taud2_3tmp(2,3,kkk,iter3)=-duxy_d-dvxy_d
                taud2_3tmp(3,3,kkk,iter3)=-duxz_d-dvxz_d
                taud2_3tmp(4,3,kkk,iter3)=-duyx_d-dvyx_d
                taud2_3tmp(5,3,kkk,iter3)=-duyy_d-dvyy_d
                taud2_3tmp(6,3,kkk,iter3)=-duyz_d-dvyz_d
                taud2_3tmp(7,3,kkk,iter3)=-duzx_d-dvzx_d
                taud2_3tmp(8,3,kkk,iter3)=-duzy_d-dvzy_d
                taud2_3tmp(9,3,kkk,iter3)=-duzz_d-dvzz_d

                taup2_3tmp(1,3,kkk,iter3)=-duxx_p-dvxx_p
                taup2_3tmp(2,3,kkk,iter3)=-duxy_p-dvxy_p
                taup2_3tmp(3,3,kkk,iter3)=-duxz_p-dvxz_p
                taup2_3tmp(4,3,kkk,iter3)=-duyx_p-dvyx_p
                taup2_3tmp(5,3,kkk,iter3)=-duyy_p-dvyy_p
                taup2_3tmp(6,3,kkk,iter3)=-duyz_p-dvyz_p
                taup2_3tmp(7,3,kkk,iter3)=-duzx_p-dvzx_p
                taup2_3tmp(8,3,kkk,iter3)=-duzy_p-dvzy_p
                taup2_3tmp(9,3,kkk,iter3)=-duzz_p-dvzz_p

                elsttau2_index_tmp(4,kkk,iter3)=0
