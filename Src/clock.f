...
c
c
      subroutine settime2(twall,tcpu)
c      use chrono
      implicit none
      integer count,crate,cmax
      real time
...
c
      ...
      call cpu_time (time)
      tcpu = dble(time)
      print*,"Hello from settime",twall,tcpu
      return
      end
c
c
...
c
c
      subroutine gettime2 (twall,tcpu)
c      use chrono
      implicit none
      integer count,crate,cmax
      real time
