      ...
      subroutine ClustEmpole1_2b_NoOmplistsimult 
...
c      real*8  dep2moli12(3,36)
      ...
      integer cnt
      real*8 ep2btmat(clustcount,clustcount)
      real*8 dep2btmat(3,2*3*maxsizeclust,clustcount,clustcount)
      real*8 virep2btmat(3,3,clustcount,clustcount)
      real*8 em2btmat(clustcount,clustcount)
      real*8 dem2btmat(3,2*3*maxsizeclust,clustcount,clustcount)
...
c      print*,"taskid=",taskid,"start_polar",start_polar(taskid_offset)
c      print*,"taskid=",taskid,"last_polar",last_polar(taskid_offset)
...
c          cnt=cnt+1
     ...
     &         ep2moli12,dep2moli12,vir2moli12,cnt,em2moli12,dem2moli12)
        ...
        !  em2moli12 = em2moli12 -em1bmat(clust1)
          ...
          ep2btmat(clust2,clust1)=ep2moli12
          em2btmat(clust2,clust1)=em2moli12

          do l1=1, npole3b
             i = pnum(l1)
             do j = 1, 3
               dep2btmat(j,l1,clust2,clust1)=dep2moli12(j,i)
               dem2btmat(j,l1,clust2,clust1)=dem2moli12(j,i)
             end do
          end do
          do i=1,3
             do j=1,3
              virep2btmat(j,i,clust2,clust1)=vir2moli12(j,i)
             end do
          end do
...
c        print*,"Clst2Btskid=",taskid,"ep2moli12=",ep2moli12
