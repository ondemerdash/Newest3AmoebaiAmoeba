...
c
c
      subroutine mlist_2bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use boxes
...
c
      ...
      if (domlstclust2b(counter)) then
         ...
         if (octahedron) then
            call mbuild_2bclust(npole3b,pnum,counter)
         else
            call mlight_2bclust(npole3b,pnum,counter)
         end if
         return
      end if
c
...
c
c
      subroutine mbuild_2bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use iounit
...
c
c
      subroutine mlight_2bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use cell
