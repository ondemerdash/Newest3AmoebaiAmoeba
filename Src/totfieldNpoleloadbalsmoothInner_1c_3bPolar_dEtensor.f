...
c     &  start,last,ep3bt,virep3bt,dep3bt,moli1rmndr)
      subroutine totfieldNpoleloadbalsmoothInner_1c_3bPolar_dEtensor(
...
c      do moli1=start_polar(taskid),last_polar(taskid)
      do moli1=1,nmol
          ...
          pnum(3)=imol(2,moli1)
          npole3b=3
           call empole1c_3b_Polar_totfield_dEtensor(npole3b,pnum,eptemp,
     &          deptemp,virtemp)
          ep1moli1=eptemp
...
c              print*,"i j dep1moli1(j,i)",i,j,dep1moli1(j,i)
     ...
     &           eptemp,deptemp,virtemp)
                 ...
                 pnum(3)=imol(2,moli3)
                 call empole1c_3b_Polar_totfield_dEtensor(
