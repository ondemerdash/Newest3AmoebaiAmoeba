c
c
      subroutine empole1a_3b_Polar_orig_nopriordiromp(npole3b,pnum,
...
c
     ...
     & uind,uinp) 
       ...
       call induce0a_3b_scf_vacomp(npole3b,pnum,uind,uinp)
      else
...
!$OMP& ddsc3,ddsc5,ddsc7,sc,sci,scip,gli,glip,gf,gfi,l1,l3)
