      subroutine empole1d_3b_Polar3btest2(npole3b,pnum,
...
c      else if (usepcgscf) then
       ...
       !print*,"Done w induce0a_3b_scf_vacomp3bclust"
c      else
...
c     & eptemp,deptemp,virtemp,emtemp,demtemp) 
      !print*,"Done w emrecip1_3b_Polartest2 in 3bclust"

      call ereal1d_3b_3bclustPolartest2(npole3b,pnum,uind,uinp,cnt,
     & eptemp,deptemp,virtemp)!,emtemp,demtemp)

      !print*,"Done w ereal1d_3b_3bclustPolartest2 in 3bclust"
...
c     &    i,trq,trqi,frcx,frcy,frcz,demtemp,deptemp)
     ...
     &    i,trq,trqi,frcx,frcy,frcz,deptemp)
      ...
      !print*,"Completed all steps of empole1d 3bclust"
      return
      end
c
c     ################################################################
...
c
c
      subroutine ereal1d_3b_3bclustPolartest2(npole3b,pnum,uind,uinp,
