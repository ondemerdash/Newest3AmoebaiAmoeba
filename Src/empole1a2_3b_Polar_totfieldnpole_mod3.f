...
c     &   uinp,deptemp,virtemp)
      subroutine empole1a2_3b_Polar_totfieldnpole_mod3(npole3b,pnum,
     &   uind,uinp,eptemp,deptemp,virtemp)
      use bound
      use sizes
      use atoms
      use chgpot
...
c
     ...
     &                      )
     &                + 0.5d0 * rr9 * (gli(3)*psc7)
               gfi(2) = -rr3*ck + rr5*sc(4) - rr7*sc(6)
               gfi(3) = rr3*ci + rr5*sc(3) + rr7*sc(5)
               gfi(4) = 2.0d0 * rr5
               gfi(5) = rr7 * (sci(4)*psc7)
               gfi(6) = -rr7 * (sci(3)*psc7)
...
c    
     ...
     &            + (rr3*ci*(uind(1,l3)*psc3)
     &            + rr5*sc(3)*(uind(1,l3)*psc5)
     &            + rr7*sc(5)*(uind(1,l3)*psc7))*0.5d0
     &           ! + rr5*scale5i*(sci(4)*uinp(1,l1)+scip(4)*uind(1,l1)
     &           ! + sci(3)*uinp(1,l3)+scip(3)*uind(1,l3))*0.5d0
     &            + 0.5d0*(sci(4)*psc5)*rr5*dix
     &            + 0.5d0*(sci(3)*psc5)*rr5*dkx
     ...
     &            + (rr3*ci*(uind(2,l3)*psc3)
     &            + rr5*sc(3)*(uind(2,l3)*psc5)
     &            + rr7*sc(5)*(uind(2,l3)*psc7))*0.5d0
     &           ! + rr5*scale5i*(sci(4)*uinp(2,l1)+scip(4)*uind(2,l1)
     &           ! + sci(3)*uinp(2,l3)+scip(3)*uind(2,l3))*0.5d0
     &            + 0.5d0*(sci(4)*psc5)*rr5*diy
     &            + 0.5d0*(sci(3)*psc5)*rr5*dky
     ...
     &            + (rr3*ci*(uind(3,l3)*psc3)
     &            + rr5*sc(3)*(uind(3,l3)*psc5)
     &            + rr7*sc(5)*(uind(3,l3)*psc7))*0.5d0
     &            ! + rr5*scale5i*(sci(4)*uinp(3,l1)+scip(4)*uind(3,l1)
     &            ! + sci(3)*uinp(3,l3)+scip(3)*uind(3,l3))*0.5d0
     &            + 0.5d0*(sci(4)*psc5)*rr5*diz
     &            + 0.5d0*(sci(3)*psc5)*rr5*dkz
...
c
               gti(2) = 0.5d0 * rr5 * (sci(4)*psc5)
               gti(3) = 0.5d0 * rr5 * (sci(3)*psc5)
