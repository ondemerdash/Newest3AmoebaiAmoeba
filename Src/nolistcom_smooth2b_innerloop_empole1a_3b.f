...
c     &  start,last,ep3bt,virep3bt,dep3bt,ntript) 
      subroutine NoListCOMSmooth2bInnerloop1_2cut_wskin( 
...
!$OMP& SwitchR2b,virep3bt,dep3bt,start,last,nmol,
!$OMP& mass,x,y,z,rtapr2b_input)
...
c      subroutine R123Smooth3b2bSmoothOnly2(
c     &  start,last,ep3bt,virep3bt,dep3bt,ntript) 
      subroutine NoListCOMSmooth2bInnerloop1_2cut_wskin_single(
...
c      if(nmollst(moli1).gt.0) then
!$OMP PARALLEL default(private) shared(imol,ep3bt,Rcut2b_input,
!$OMP& SwitchR2b,virep3bt,dep3bt,moli1,nmol,
!$OMP& mass,x,y,z,rtapr2b_input)
!$OMP DO reduction(+:ep3bt,virep3bt,dep3bt)
!$OMP& schedule(guided)
