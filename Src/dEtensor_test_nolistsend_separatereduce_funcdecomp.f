...
c              end if
           else if(taskid.eq.master.and.
     &                (approxmode.ne.'1BODYMODE')) then
...
c            if(approxmode.eq.'1BODYMODE') then
            call ewtotfieldsmooth2_gradient_polar_1body_dEtensormpioff2
c            else
c            call ewtotfieldsmooth2_gradient_polar_load_balanced_dEtensor
c            end if
              if(approxmode.ne.'1BODYMODE') then
               if((cut2b_input.gt.20.0d0).or.
     &               (Cobarcut3b.gt.20.0d0)) then
