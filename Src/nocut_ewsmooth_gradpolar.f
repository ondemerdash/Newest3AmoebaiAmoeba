      subroutine nocut_ew_2body_gradient_polar(start,last,moli1rmndr)
      use mpole
      use mpidat
      use deriv3b
      implicit none
      ...
      do i=1,3
        ...
        call NoCutSmoothInnerloop2body_ew(ep3bt,virep3bt,
     &  dep3bt,start,last,moli1rmndr)
...
c       print*,"In loadbal gradient_polar After mpi_reduce ",taskid,ep3bt
      ...
      subroutine nocut_ew_3body_gradient_polar(start,last,moli1rmndr) 
      use mpole
      use mpidat
      use deriv3b
      implicit none
      ...
      ntript=0
        ...
        call NoCutSmoothInnerloop3body_ew(ep3bt,virep3bt,
     &  dep3bt,ntript,start,last,moli1rmndr)
