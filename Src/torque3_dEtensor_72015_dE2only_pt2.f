...
c
c
      subroutine torque3_dEtensor_72015_dE2only_pt2(i,trq1,trq2,frcx,
     &          frcy,frcz,demi,Ed,Ep,nlocal,ilocal,
     &          dlocal2d,dlocal2p,k)
      use sizes
      use atoms
      use deriv
...
c     result of infinitesimal rotation along these vectors
c
      print*,"!!!IN NON-MOD PT2 NEW TENSOR TORQ"
