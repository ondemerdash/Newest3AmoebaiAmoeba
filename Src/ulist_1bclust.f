...
c
c
      subroutine ulist_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use boxes
...
c
      ...
      if (doulstclust1b(counter)) then
         ...
         if (octahedron) then
            call ubuild_1bclust(npole3b,pnum,counter)
         else
            call ulight_1bclust(npole3b,pnum,counter)
         end if
         return
      end if
c
...
c
c
      subroutine ubuild_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use iounit
...
c
c
      subroutine ulight_1bclust(npole3b,pnum,counter)
      use sizes
      use atoms
      use bound
      use cell
