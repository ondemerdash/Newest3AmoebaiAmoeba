...
c
c
      subroutine kewald_noqpole_nodpole
      use sizes
      use atoms
      use bound
      use boxes
...
c
     ...
     ! if (.not. allocated(thetai3))  allocate (thetai3(4,bsorder,n))
      ...
      if (.not. allocated(thetai1))  allocate (thetai1(bsorder,n))
      if (.not. allocated(thetai2))  allocate (thetai2(bsorder,n))
      if (.not. allocated(thetai3))  allocate (thetai3(bsorder,n))
