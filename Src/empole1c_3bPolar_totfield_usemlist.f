      subroutine empole1c_3b_Polar_totfield_usemlist(npole3b,pnum,
...
c   Zero out temporary gradient of polarization energy
      ...
      do l1 = 1, npole3b
        ...
        do j=1,nelst(i)
          ...
          embedlst(nembedlst(l1),l1)=elst(j,i)
        end do
        do j=1,i-1
           do k=1,nelst(j)
              if(elst(k,j).eq.i) then
                 nembedlst(l1)=nembedlst(l1)+1
      ...
      !print*,"Using Mlist Empole1c_3b_totfieldnnpole"

       call induce0a_3b_totfield(npole3b,pnum,uind,uinp,qgrid3b,
     &                 planf3b,planb3b,iprime3b,ffttable3b)
           

c      call emrecip1_1and2_3b_Polar_totfield_parl_513(npole3b,pnum,
c     &   uind,uinp,eptemp,deptemp,virtemp,qgrid3b,
c     &   planf3b,planb3b,
